...
void PlayFab::AdminModels::writeAttributeNotSpecifiedBehaviorEnumJSON(AttributeNotSpecifiedBehavior enumVal, JsonWriter& writer)
{
    switch (enumVal)
    {

    case AttributeNotSpecifiedBehaviorUseDefault: writer->WriteValue(TEXT("UseDefault")); break;
    case AttributeNotSpecifiedBehaviorMatchAny: writer->WriteValue(TEXT("MatchAny")); break;
    }
}

AdminModels::AttributeNotSpecifiedBehavior PlayFab::AdminModels::readAttributeNotSpecifiedBehaviorFromValue(const TSharedPtr<FJsonValue>& value)
{
    return readAttributeNotSpecifiedBehaviorFromValue(value.IsValid() ? value->AsString() : "");
}

AdminModels::AttributeNotSpecifiedBehavior PlayFab::AdminModels::readAttributeNotSpecifiedBehaviorFromValue(const FString& value)
{
    static TMap<FString, AttributeNotSpecifiedBehavior> _AttributeNotSpecifiedBehaviorMap;
    if (_AttributeNotSpecifiedBehaviorMap.Num() == 0)
    {
        // Auto-generate the map on the first use
        _AttributeNotSpecifiedBehaviorMap.Add(TEXT("UseDefault"), AttributeNotSpecifiedBehaviorUseDefault);
        _AttributeNotSpecifiedBehaviorMap.Add(TEXT("MatchAny"), AttributeNotSpecifiedBehaviorMatchAny);

    }

    if (!value.IsEmpty())
    {
        auto output = _AttributeNotSpecifiedBehaviorMap.Find(value);
        if (output != nullptr)
            return *output;
    }
...
void PlayFab::AdminModels::writeAttributeSourceEnumJSON(AttributeSource enumVal, JsonWriter& writer)
{
    switch (enumVal)
    {

    case AttributeSourceUser: writer->WriteValue(TEXT("User")); break;
    case AttributeSourcePlayerEntity: writer->WriteValue(TEXT("PlayerEntity")); break;
    }
}

AdminModels::AttributeSource PlayFab::AdminModels::readAttributeSourceFromValue(const TSharedPtr<FJsonValue>& value)
{
    return readAttributeSourceFromValue(value.IsValid() ? value->AsString() : "");
}

AdminModels::AttributeSource PlayFab::AdminModels::readAttributeSourceFromValue(const FString& value)
{
    static TMap<FString, AttributeSource> _AttributeSourceMap;
    if (_AttributeSourceMap.Num() == 0)
    {
        // Auto-generate the map on the first use
        _AttributeSourceMap.Add(TEXT("User"), AttributeSourceUser);
        _AttributeSourceMap.Add(TEXT("PlayerEntity"), AttributeSourcePlayerEntity);

    }

    if (!value.IsEmpty())
    {
        auto output = _AttributeSourceMap.Find(value);
        if (output != nullptr)
            return *output;
    }
...
void PlayFab::AdminModels::FDeleteMasterPlayerAccountRequest::writeJSON(JsonWriter& writer) const
{
    ...
    if (MetaData.IsEmpty() == false) { writer->WriteIdentifierPrefix(TEXT("MetaData")); writer->WriteValue(MetaData); }
...
PlayFab::AdminModels::FGetMatchmakingQueueRequest::~FGetMatchmakingQueueRequest()
{

}

void PlayFab::AdminModels::FGetMatchmakingQueueRequest::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
...
bool PlayFab::AdminModels::FGetMatchmakingQueueRequest::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
...
PlayFab::AdminModels::FQueueRuleAttribute::~FQueueRuleAttribute()
{

}

void PlayFab::AdminModels::FQueueRuleAttribute::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();

    writer->WriteIdentifierPrefix(TEXT("Path")); writer->WriteValue(Path);

    writer->WriteIdentifierPrefix(TEXT("Source")); writeAttributeSourceEnumJSON(Source, writer);

    writer->WriteObjectEnd();
}

bool PlayFab::AdminModels::FQueueRuleAttribute::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;

    const TSharedPtr<FJsonValue> PathValue = obj->TryGetField(TEXT("Path"));
    if (PathValue.IsValid() && !PathValue->IsNull())
    {
        FString TmpValue;
        if (PathValue->TryGetString(TmpValue)) { Path = TmpValue; }
    }

    Source = readAttributeSourceFromValue(obj->TryGetField(TEXT("Source")));

    return HasSucceeded;
}

void PlayFab::AdminModels::writeRuleTypeEnumJSON(RuleType enumVal, JsonWriter& writer)
{
    switch (enumVal)
    {
...
AdminModels::RuleType PlayFab::AdminModels::readRuleTypeFromValue(const TSharedPtr<FJsonValue>& value)
{
    return readRuleTypeFromValue(value.IsValid() ? value->AsString() : "");
}

AdminModels::RuleType PlayFab::AdminModels::readRuleTypeFromValue(const FString& value)
{
...
PlayFab::AdminModels::FMatchmakingQueueRule::~FMatchmakingQueueRule()
{

}

void PlayFab::AdminModels::FMatchmakingQueueRule::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();

    writer->WriteIdentifierPrefix(TEXT("Attribute")); Attribute.writeJSON(writer);

    if (pfAttributeNotSpecifiedBehavior.notNull()) { writer->WriteIdentifierPrefix(TEXT("AttributeNotSpecifiedBehavior")); writeAttributeNotSpecifiedBehaviorEnumJSON(pfAttributeNotSpecifiedBehavior, writer); }
...
bool PlayFab::AdminModels::FMatchmakingQueueRule::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;

    const TSharedPtr<FJsonValue> AttributeValue = obj->TryGetField(TEXT("Attribute"));
    if (AttributeValue.IsValid() && !AttributeValue->IsNull())
    {
        Attribute = FQueueRuleAttribute(AttributeValue->AsObject());
    }

    pfAttributeNotSpecifiedBehavior = readAttributeNotSpecifiedBehaviorFromValue(obj->TryGetField(TEXT("AttributeNotSpecifiedBehavior")));
...
PlayFab::AdminModels::FMatchmakingQueueConfig::~FMatchmakingQueueConfig()
{

}

void PlayFab::AdminModels::FMatchmakingQueueConfig::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
...
bool PlayFab::AdminModels::FMatchmakingQueueConfig::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
...
PlayFab::AdminModels::FGetMatchmakingQueueResult::~FGetMatchmakingQueueResult()
{
    //if (MatchmakingQueue != nullptr) delete MatchmakingQueue;

}

void PlayFab::AdminModels::FGetMatchmakingQueueResult::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
...
bool PlayFab::AdminModels::FGetMatchmakingQueueResult::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
...
PlayFab::AdminModels::FListMatchmakingQueuesRequest::~FListMatchmakingQueuesRequest()
{

}

void PlayFab::AdminModels::FListMatchmakingQueuesRequest::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
...
bool PlayFab::AdminModels::FListMatchmakingQueuesRequest::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
...
PlayFab::AdminModels::FListMatchmakingQueuesResult::~FListMatchmakingQueuesResult()
{

}

void PlayFab::AdminModels::FListMatchmakingQueuesResult::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
...
bool PlayFab::AdminModels::FListMatchmakingQueuesResult::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
...
PlayFab::AdminModels::FRemoveMatchmakingQueueRequest::~FRemoveMatchmakingQueueRequest()
{

}

void PlayFab::AdminModels::FRemoveMatchmakingQueueRequest::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
...
bool PlayFab::AdminModels::FRemoveMatchmakingQueueRequest::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
...
PlayFab::AdminModels::FRemoveMatchmakingQueueResult::~FRemoveMatchmakingQueueResult()
{

}

void PlayFab::AdminModels::FRemoveMatchmakingQueueResult::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
...
bool PlayFab::AdminModels::FRemoveMatchmakingQueueResult::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
...
PlayFab::AdminModels::FSetMatchmakingQueueRequest::~FSetMatchmakingQueueRequest()
{
    //if (MatchmakingQueue != nullptr) delete MatchmakingQueue;

}

void PlayFab::AdminModels::FSetMatchmakingQueueRequest::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
...
bool PlayFab::AdminModels::FSetMatchmakingQueueRequest::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
...
PlayFab::AdminModels::FSetMatchmakingQueueResult::~FSetMatchmakingQueueResult()
{

}

void PlayFab::AdminModels::FSetMatchmakingQueueResult::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
...
bool PlayFab::AdminModels::FSetMatchmakingQueueResult::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
