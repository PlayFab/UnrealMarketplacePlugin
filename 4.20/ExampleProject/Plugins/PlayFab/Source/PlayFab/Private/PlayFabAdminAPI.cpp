...
UPlayFabAdminAPI* UPlayFabAdminAPI::GetMatchmakingQueue(FAdminGetMatchmakingQueueRequest request,
    ...
    UObject* customData)
{
    ...
    manager->OnFailure = onFailure;
    manager->OnPlayFabResponse.AddDynamic(manager, &UPlayFabAdminAPI::HelperGetMatchmakingQueue);

    // Setup the request
    manager->PlayFabRequestURL = "/Admin/GetMatchmakingQueue";
    manager->useSecretKey = true;
...
// Implements FOnPlayFabAdminRequestCompleted
void UPlayFabAdminAPI::HelperGetMatchmakingQueue(FPlayFabBaseModel response, UObject* customData, bool successful)
{
    FPlayFabError error = response.responseError;
    if (error.hasError && OnFailure.IsBound())
    {
    ...
    {
        FAdminGetMatchmakingQueueResult result = UPlayFabAdminModelDecoder::decodeGetMatchmakingQueueResultResponse(response.responseData);
        OnSuccessGetMatchmakingQueue.Execute(result, mCustomData);
    }
    this->RemoveFromRoot();
}

/** List all matchmaking queue configs. */
UPlayFabAdminAPI* UPlayFabAdminAPI::ListMatchmakingQueues(FAdminListMatchmakingQueuesRequest request,
    ...
    UObject* customData)
{
    ...
    manager->OnFailure = onFailure;
    manager->OnPlayFabResponse.AddDynamic(manager, &UPlayFabAdminAPI::HelperListMatchmakingQueues);

    // Setup the request
    manager->PlayFabRequestURL = "/Admin/ListMatchmakingQueues";
    manager->useSecretKey = true;
...
// Implements FOnPlayFabAdminRequestCompleted
void UPlayFabAdminAPI::HelperListMatchmakingQueues(FPlayFabBaseModel response, UObject* customData, bool successful)
{
    FPlayFabError error = response.responseError;
    if (error.hasError && OnFailure.IsBound())
    {
    ...
    {
        FAdminListMatchmakingQueuesResult result = UPlayFabAdminModelDecoder::decodeListMatchmakingQueuesResultResponse(response.responseData);
        OnSuccessListMatchmakingQueues.Execute(result, mCustomData);
    }
    this->RemoveFromRoot();
}
...
UPlayFabAdminAPI* UPlayFabAdminAPI::RemoveMatchmakingQueue(FAdminRemoveMatchmakingQueueRequest request,
    ...
    UObject* customData)
{
    ...
    manager->OnFailure = onFailure;
    manager->OnPlayFabResponse.AddDynamic(manager, &UPlayFabAdminAPI::HelperRemoveMatchmakingQueue);

    // Setup the request
    manager->PlayFabRequestURL = "/Admin/RemoveMatchmakingQueue";
    manager->useSecretKey = true;
...
// Implements FOnPlayFabAdminRequestCompleted
void UPlayFabAdminAPI::HelperRemoveMatchmakingQueue(FPlayFabBaseModel response, UObject* customData, bool successful)
{
    FPlayFabError error = response.responseError;
    if (error.hasError && OnFailure.IsBound())
    {
    ...
    {
        FAdminRemoveMatchmakingQueueResult result = UPlayFabAdminModelDecoder::decodeRemoveMatchmakingQueueResultResponse(response.responseData);
        OnSuccessRemoveMatchmakingQueue.Execute(result, mCustomData);
    }
    this->RemoveFromRoot();
}

/** Create or update a matchmaking queue configuration. */
UPlayFabAdminAPI* UPlayFabAdminAPI::SetMatchmakingQueue(FAdminSetMatchmakingQueueRequest request,
    ...
    UObject* customData)
{
    ...
    manager->OnFailure = onFailure;
    manager->OnPlayFabResponse.AddDynamic(manager, &UPlayFabAdminAPI::HelperSetMatchmakingQueue);

    // Setup the request
    manager->PlayFabRequestURL = "/Admin/SetMatchmakingQueue";
    manager->useSecretKey = true;
...
// Implements FOnPlayFabAdminRequestCompleted
void UPlayFabAdminAPI::HelperSetMatchmakingQueue(FPlayFabBaseModel response, UObject* customData, bool successful)
{
    FPlayFabError error = response.responseError;
    if (error.hasError && OnFailure.IsBound())
    {
    ...
    {
        FAdminSetMatchmakingQueueResult result = UPlayFabAdminModelDecoder::decodeSetMatchmakingQueueResultResponse(response.responseData);
        OnSuccessSetMatchmakingQueue.Execute(result, mCustomData);
    }
    this->RemoveFromRoot();
}
