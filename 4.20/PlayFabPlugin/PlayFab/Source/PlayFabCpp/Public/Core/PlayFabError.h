...
namespace PlayFab
{
    ...
    enum PLAYFABCPP_API PlayFabErrorCode
    {
        ...
        PlayFabErrorCannotEnablePartiesForTitle = 2054,
        PlayFabErrorPartyError = 2055,
        PlayFabErrorPartyRequests = 2056,
        PlayFabErrorPartyNoContent = 2057,
        PlayFabErrorPartyBadRequest = 2058,
        PlayFabErrorPartyUnauthorized = 2059,
        PlayFabErrorPartyForbidden = 2060,
        PlayFabErrorPartyNotFound = 2061,
        PlayFabErrorPartyConflict = 2062,
        PlayFabErrorPartyInternalServerError = 2063,
        PlayFabErrorPartyUnavailable = 2064,
        PlayFabErrorPartyTooManyRequests = 2065,
