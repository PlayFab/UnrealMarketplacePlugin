...
{
    const FString PlayFabCommonSettings::sdkVersion = "1.28.191029";
    const FString PlayFabCommonSettings::buildIdentifier = "jbuild_unrealmarketplaceplugin__sdk-unrealslave-2b_0";
    const FString PlayFabCommonSettings::versionString = "UE4MKPL-1.28.191029";
