...
namespace PlayFab
{
    ...
    enum PLAYFABCPP_API PlayFabErrorCode
    {
        ...
        PlayFabErrorKustoProxyQueryRateLimitExceeded = 1455,
        PlayFabErrorEntityAPIKeyCreationDisabledForEntity = 1456,
        PlayFabErrorStudioCreationRateLimited = 1457,
        PlayFabErrorStudioCreationInProgress = 1458,
        PlayFabErrorDuplicateStudioName = 1459,
        PlayFabErrorStudioNotFound = 1460,
        PlayFabErrorStudioDeletionInProgress = 1461,
        PlayFabErrorStudioDeactivated = 1462,
        PlayFabErrorTitleCreationRateLimited = 1463,
        PlayFabErrorTitleCreationInProgress = 1464,
        PlayFabErrorDuplicateTitleName = 1465,
        PlayFabErrorTitleNotFound = 1466,
        PlayFabErrorTitleDeletionInProgress = 1467,
        PlayFabErrorTitleDeactivated = 1468,
        PlayFabErrorTitleAlreadyActivated = 1469,
