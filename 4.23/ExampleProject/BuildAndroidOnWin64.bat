...
pushd "%uatPath%"
.\RunUAT.bat -ScriptsForProject="%~dp0ExampleProject.uproject" BuildCookRun -editorrecompile -installed -project="%~dp0ExampleProject.uproject" -cook -stage -archive -archivedirectory="%archivePath%" -package -clientconfig=Development -ue4exe=UE4Editor-Cmd.exe -pak -prereqs -targetplatform=Android -cookflavor=Multi -build -utf8output
popd 
