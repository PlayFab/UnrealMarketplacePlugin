...
enum class EAzureVmFamily : uint8
{
    ...
    pfenum_Eav4 = 8 UMETA(DisplayName = "Eav4"),
    pfenum_Easv4 = 9 UMETA(DisplayName = "Easv4"),
    pfenum_Ev4 = 10 UMETA(DisplayName = "Ev4"),
    pfenum_Esv4 = 11 UMETA(DisplayName = "Esv4"),
    pfenum_Dsv3 = 12 UMETA(DisplayName = "Dsv3"),
    pfenum_Dsv2 = 13 UMETA(DisplayName = "Dsv2"),
    pfenum_NCasT4_v3 = 14 UMETA(DisplayName = "NCasT4_v3"),
    pfenum_Ddv4 = 15 UMETA(DisplayName = "Ddv4"),
    pfenum_Ddsv4 = 16 UMETA(DisplayName = "Ddsv4"),
    pfenum_HBv3 = 17 UMETA(DisplayName = "HBv3"),
};
...
enum class EAzureVmSize : uint8
{
    ...
    pfenum_Standard_E2a_v4 = 34 UMETA(DisplayName = "Standard_E2a_v4"),
    pfenum_Standard_E4a_v4 = 35 UMETA(DisplayName = "Standard_E4a_v4"),
    pfenum_Standard_E8a_v4 = 36 UMETA(DisplayName = "Standard_E8a_v4"),
    pfenum_Standard_E16a_v4 = 37 UMETA(DisplayName = "Standard_E16a_v4"),
    pfenum_Standard_E2as_v4 = 38 UMETA(DisplayName = "Standard_E2as_v4"),
    pfenum_Standard_E4as_v4 = 39 UMETA(DisplayName = "Standard_E4as_v4"),
    pfenum_Standard_E8as_v4 = 40 UMETA(DisplayName = "Standard_E8as_v4"),
    pfenum_Standard_E16as_v4 = 41 UMETA(DisplayName = "Standard_E16as_v4"),
    pfenum_Standard_D2s_v3 = 42 UMETA(DisplayName = "Standard_D2s_v3"),
    pfenum_Standard_D4s_v3 = 43 UMETA(DisplayName = "Standard_D4s_v3"),
    pfenum_Standard_D8s_v3 = 44 UMETA(DisplayName = "Standard_D8s_v3"),
    pfenum_Standard_D16s_v3 = 45 UMETA(DisplayName = "Standard_D16s_v3"),
    pfenum_Standard_DS1_v2 = 46 UMETA(DisplayName = "Standard_DS1_v2"),
    pfenum_Standard_DS2_v2 = 47 UMETA(DisplayName = "Standard_DS2_v2"),
    pfenum_Standard_DS3_v2 = 48 UMETA(DisplayName = "Standard_DS3_v2"),
    pfenum_Standard_DS4_v2 = 49 UMETA(DisplayName = "Standard_DS4_v2"),
    pfenum_Standard_DS5_v2 = 50 UMETA(DisplayName = "Standard_DS5_v2"),
    pfenum_Standard_NC4as_T4_v3 = 51 UMETA(DisplayName = "Standard_NC4as_T4_v3"),
    pfenum_Standard_D2d_v4 = 52 UMETA(DisplayName = "Standard_D2d_v4"),
    pfenum_Standard_D4d_v4 = 53 UMETA(DisplayName = "Standard_D4d_v4"),
    pfenum_Standard_D8d_v4 = 54 UMETA(DisplayName = "Standard_D8d_v4"),
    pfenum_Standard_D16d_v4 = 55 UMETA(DisplayName = "Standard_D16d_v4"),
    pfenum_Standard_D2ds_v4 = 56 UMETA(DisplayName = "Standard_D2ds_v4"),
    pfenum_Standard_D4ds_v4 = 57 UMETA(DisplayName = "Standard_D4ds_v4"),
    pfenum_Standard_D8ds_v4 = 58 UMETA(DisplayName = "Standard_D8ds_v4"),
    pfenum_Standard_D16ds_v4 = 59 UMETA(DisplayName = "Standard_D16ds_v4"),
    pfenum_Standard_HB120_16rs_v3 = 60 UMETA(DisplayName = "Standard_HB120_16rs_v3"),
    pfenum_Standard_HB120_32rs_v3 = 61 UMETA(DisplayName = "Standard_HB120_32rs_v3"),
    pfenum_Standard_HB120_64rs_v3 = 62 UMETA(DisplayName = "Standard_HB120_64rs_v3"),
    pfenum_Standard_HB120_96rs_v3 = 63 UMETA(DisplayName = "Standard_HB120_96rs_v3"),
    pfenum_Standard_HB120rs_v3 = 64 UMETA(DisplayName = "Standard_HB120rs_v3"),
};
