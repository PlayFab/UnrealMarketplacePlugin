...
public:
    ...
    // callbacks
    DECLARE_DYNAMIC_DELEGATE_TwoParams(FDelegateOnSuccessGetPlayFabIDsFromBattleNetAccountIds, FServerGetPlayFabIDsFromBattleNetAccountIdsResult, result, UObject*, customData);

    /** Retrieves the unique PlayFab identifiers for the given set of Battle.net account identifiers. */
    UFUNCTION(BlueprintCallable, Category = "PlayFab | Server | Account Management ", meta = (BlueprintInternalUseOnly = "true"))
        static UPlayFabServerAPI* GetPlayFabIDsFromBattleNetAccountIds(FServerGetPlayFabIDsFromBattleNetAccountIdsRequest request,
    ...
    UFUNCTION(BlueprintCallable, Category = "PlayFab | Server | Account Management ", meta = (BlueprintInternalUseOnly = "true"))
        static UPlayFabServerAPI* LinkNintendoServiceAccountSubject(FServerLinkNintendoServiceAccountSubjectRequest request,
    ...
    UFUNCTION(BlueprintCallable, Category = "PlayFab | Server | Account Management ", meta = (BlueprintInternalUseOnly = "true"))
        static UPlayFabServerAPI* LinkPSNId(FServerLinkPSNIdRequest request,
    ...
    // callbacks
    DECLARE_DYNAMIC_DELEGATE_TwoParams(FDelegateOnSuccessUnlinkFacebookAccount, FServerUnlinkFacebookAccountResult, result, UObject*, customData);

    /** Unlinks the related Facebook account from the user's PlayFab account */
    UFUNCTION(BlueprintCallable, Category = "PlayFab | Server | Account Management ", meta = (BlueprintInternalUseOnly = "true"))
        static UPlayFabServerAPI* UnlinkFacebookAccount(FServerUnlinkFacebookAccountRequest request,
    ...
    // callbacks
    DECLARE_DYNAMIC_DELEGATE_TwoParams(FDelegateOnSuccessUnlinkFacebookInstantGamesId, FServerUnlinkFacebookInstantGamesIdResult, result, UObject*, customData);

    /** Unlinks the related Facebook Instant Games identifier from the user's PlayFab account */
    UFUNCTION(BlueprintCallable, Category = "PlayFab | Server | Account Management ", meta = (BlueprintInternalUseOnly = "true"))
        static UPlayFabServerAPI* UnlinkFacebookInstantGamesId(FServerUnlinkFacebookInstantGamesIdRequest request,
    ...
    // callbacks
    DECLARE_DYNAMIC_DELEGATE_TwoParams(FDelegateOnSuccessLoginWithAndroidDeviceID, FServerServerLoginResult, result, UObject*, customData);
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "PlayFab | Server | Authentication ", meta = (BlueprintInternalUseOnly = "true"))
        static UPlayFabServerAPI* LoginWithAndroidDeviceID(FServerLoginWithAndroidDeviceIDRequest request,
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "PlayFab | Server | Authentication ", meta = (BlueprintInternalUseOnly = "true"))
        static UPlayFabServerAPI* LoginWithCustomID(FServerLoginWithCustomIDRequest request,
    ...
    // callbacks
    DECLARE_DYNAMIC_DELEGATE_TwoParams(FDelegateOnSuccessLoginWithIOSDeviceID, FServerServerLoginResult, result, UObject*, customData);
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "PlayFab | Server | Authentication ", meta = (BlueprintInternalUseOnly = "true"))
        static UPlayFabServerAPI* LoginWithIOSDeviceID(FServerLoginWithIOSDeviceIDRequest request,
    ...
    // callbacks
    DECLARE_DYNAMIC_DELEGATE_TwoParams(FDelegateOnSuccessExportPlayersInSegment, FServerExportPlayersInSegmentResult, result, UObject*, customData);
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "PlayFab | Server | PlayStream ", meta = (BlueprintInternalUseOnly = "true"))
        static UPlayFabServerAPI* ExportPlayersInSegment(FServerExportPlayersInSegmentRequest request,
    ...
    // callbacks
    DECLARE_DYNAMIC_DELEGATE_TwoParams(FDelegateOnSuccessGetSegmentExport, FServerGetPlayersInSegmentExportResponse, result, UObject*, customData);
     ...
     */
    UFUNCTION(BlueprintCallable, Category = "PlayFab | Server | PlayStream ", meta = (BlueprintInternalUseOnly = "true"))
        static UPlayFabServerAPI* GetSegmentExport(FServerGetPlayersInSegmentExportRequest request,
    ...
    // callbacks
    DECLARE_DYNAMIC_DELEGATE_TwoParams(FDelegateOnSuccessGetSegmentPlayerCount, FServerGetSegmentPlayerCountResult, result, UObject*, customData);

    /** Returns the total number of players in a given segment. */
    UFUNCTION(BlueprintCallable, Category = "PlayFab | Server | PlayStream ", meta = (BlueprintInternalUseOnly = "true"))
        static UPlayFabServerAPI* GetSegmentPlayerCount(FServerGetSegmentPlayerCountRequest request,
