...
{
    const FString PlayFabCommonSettings::sdkVersion = "1.39.200615";
    const FString PlayFabCommonSettings::buildIdentifier = "jbuild_unrealmarketplaceplugin__sdk-unrealslave-5_0";
    const FString PlayFabCommonSettings::versionString = "UE4MKPL-1.39.200615";
