...
bool UPlayFabProgressionInstanceAPI::GetStatisticDefinitions(
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabProgressionInstanceAPI::OnGetStatisticDefinitionsResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabProgressionInstanceAPI::OnGetStatisticDefinitionsResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FGetStatisticDefinitionsDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
