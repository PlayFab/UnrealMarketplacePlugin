...
namespace PlayFab
{
    ...
    enum PLAYFABCPP_API PlayFabErrorCode
    {
        ...
        PlayFabErrorPlayStreamConnectionFailed = 1547,
        PlayFabErrorInvalidEventContents = 1548,
        PlayFabErrorInsightsV1Deprecated = 1549,
        PlayFabErrorAnalysisSubscriptionNotFound = 1550,
        PlayFabErrorAnalysisSubscriptionFailed = 1551,
        ...
        PlayFabErrorEntityAPIKeysNotSupported = 1556,
        PlayFabErrorIpAddressBanned = 1557,
        PlayFabErrorEntityLineageBanned = 1558,
        ...
        PlayFabErrorLeaderboardCountLimitExceeded = 1574,
        PlayFabErrorLeaderboardSizeLimitExceeded = 1575,
        PlayFabErrorLeaderboardDefinitionModificationNotAllowedWhileLinked = 1576,
        ...
        PlayFabErrorResetIntervalCannotBeModified = 1598,
        ...
        PlayFabErrorAzureSubscriptionNotEligibleForLinking = 1614,
        PlayFabErrorEntityIsNotAMember = 1615,
        PlayFabErrorIPAddressNotFound = 1616,
        PlayFabErrorPSNNextGenNotConfiguredForTitle = 1617,
        PlayFabErrorInvalidNintendoIssuer = 1618,
        ...
        PlayFabErrorExperimentationExperimentDeleteFailed = 7025,
        PlayFabErrorExperimentationExperimentStartFailed = 7026,
        ...
        PlayFabErrorGetSegmentPlayerCountNotInFlight = 10016,
        PlayFabErrorGetSegmentPlayerCountRateLimitExceeded = 10017,
        ...
        PlayFabErrorTelemetryKeyNotFound = 14200,
        PlayFabErrorTelemetryKeyInvalidName = 14201,
        ...
        PlayFabErrorTelemetryKeyLongInsightsRetentionNotAllowed = 14206,
        ...
        PlayFabErrorEventSinkResourceMisconfigured = 15016,
        PlayFabErrorEventSinkAccessDenied = 15017,
        PlayFabErrorEventSinkWriteConflict = 15018,
        PlayFabErrorEventSinkResourceNotFound = 15019,
        PlayFabErrorEventSinkResourceFeatureNotSupported = 15020,
        PlayFabErrorEventSinkBucketNameInvalid = 15021,
        PlayFabErrorEventSinkResourceUnavailable = 15022,
        ...
        PlayFabErrorManageEventNamespaceInvalid = 18002,
        PlayFabErrorManageEventNameInvalid = 18003,
        PlayFabErrorManagedEventNotFound = 18004,
        PlayFabErrorManageEventsInvalidRatio = 18005,
        PlayFabErrorManagedEventInvalid = 18006,
        ...
        PlayFabErrorTrueSkillInvalidTitleId = 20001,
        PlayFabErrorTrueSkillInvalidScenarioId = 20002,
        PlayFabErrorTrueSkillInvalidModelId = 20003,
        PlayFabErrorTrueSkillInvalidModelName = 20004,
        PlayFabErrorTrueSkillInvalidPlayerIds = 20005,
        PlayFabErrorTrueSkillInvalidEntityKey = 20006,
        PlayFabErrorTrueSkillInvalidConditionKey = 20007,
        PlayFabErrorTrueSkillInvalidConditionValue = 20008,
        PlayFabErrorTrueSkillInvalidConditionAffinityWeight = 20009,
        PlayFabErrorTrueSkillInvalidEventName = 20010,
        PlayFabErrorTrueSkillMatchResultCreated = 20011,
        PlayFabErrorTrueSkillMatchResultAlreadySubmitted = 20012,
        PlayFabErrorTrueSkillBadPlayerIdInMatchResult = 20013,
        PlayFabErrorTrueSkillInvalidBotIdInMatchResult = 20014,
        PlayFabErrorTrueSkillDuplicatePlayerInMatchResult = 20015,
        PlayFabErrorTrueSkillNoPlayerInMatchResultTeam = 20016,
        PlayFabErrorTrueSkillPlayersInMatchResultExceedingLimit = 20017,
        PlayFabErrorTrueSkillInvalidPreMatchPartyInMatchResult = 20018,
        PlayFabErrorTrueSkillInvalidTimestampInMatchResult = 20019,
        PlayFabErrorTrueSkillStartTimeMissingInMatchResult = 20020,
        PlayFabErrorTrueSkillEndTimeMissingInMatchResult = 20021,
        PlayFabErrorTrueSkillInvalidPlayerSecondsPlayedInMatchResult = 20022,
        PlayFabErrorTrueSkillNoTeamInMatchResult = 20023,
        PlayFabErrorTrueSkillNotEnoughTeamsInMatchResult = 20024,
        PlayFabErrorTrueSkillInvalidRanksInMatchResult = 20025,
        PlayFabErrorTrueSkillNoWinnerInMatchResult = 20026,
        PlayFabErrorTrueSkillMissingRequiredCondition = 20027,
        PlayFabErrorTrueSkillMissingRequiredEvent = 20028,
        PlayFabErrorTrueSkillUnknownEventName = 20029,
        PlayFabErrorTrueSkillInvalidEventCount = 20030,
        PlayFabErrorTrueSkillUnknownConditionKey = 20031,
        PlayFabErrorTrueSkillUnknownConditionValue = 20032,
        PlayFabErrorTrueSkillScenarioConfigDoesNotExist = 20033,
        PlayFabErrorTrueSkillUnknownModelId = 20034,
        PlayFabErrorTrueSkillNoModelInScenario = 20035,
        PlayFabErrorTrueSkillNotSupportedForTitle = 20036,
        PlayFabErrorTrueSkillModelIsNotActive = 20037,
        PlayFabErrorTrueSkillUnauthorizedToQueryOtherPlayerSkills = 20038,
        PlayFabErrorTrueSkillInvalidMaxIterations = 20039,
        PlayFabErrorTrueSkillEndTimeBeforeStartTime = 20040,
        PlayFabErrorTrueSkillInvalidJobId = 20041,
        PlayFabErrorTrueSkillInvalidMetadataId = 20042,
        PlayFabErrorTrueSkillMissingBuildVerison = 20043,
        ...
        PlayFabErrorGameSaveManifestUpdatesNotAllowed = 20303,
        PlayFabErrorGameSaveFileAlreadyExists = 20304,
        PlayFabErrorGameSaveManifestVersionNotFinalized = 20305,
        ...
        PlayFabErrorGameSaveBaseVersionNotAvailable = 20313,
        PlayFabErrorGameSaveManifestVersionQuarantined = 20314,
        PlayFabErrorGameSaveManifestUploadProgressUpdateNotAllowed = 20315,
        PlayFabErrorGameSaveNotFinalizedManifestNotEligibleAsKnownGood = 20316,
        PlayFabErrorGameSaveNoUpdatesRequested = 20317,
        ...
        PlayFabErrorGameSaveTitleClientAnonymousAccountCreationNotDisabled = 20330,
