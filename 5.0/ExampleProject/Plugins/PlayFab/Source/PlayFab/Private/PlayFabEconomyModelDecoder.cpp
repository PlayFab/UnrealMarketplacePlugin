...
FEconomyAddInventoryItemsResponse UPlayFabEconomyModelDecoder::decodeAddInventoryItemsResponseResponse(UPlayFabJsonObject* response)
{
    ...
    tempStruct.InventoryItems = !(dataObj->HasField("InventoryItems")) ? TArray<UPlayFabJsonObject*>() : dataObj->GetObjectArrayField("InventoryItems");
    tempStruct.InventoryTooLarge = !(dataObj->HasField("InventoryTooLarge")) ? false : dataObj->GetBoolField("InventoryTooLarge");
    ...
    tempStruct.UpdatedItems = !(dataObj->HasField("UpdatedItems")) ? TArray<UPlayFabJsonObject*>() : dataObj->GetObjectArrayField("UpdatedItems");
