    ...
    UObject* customData)
{
    ...
    manager->OnFailure = onFailure;
    manager->OnPlayFabResponse.AddDynamic(manager, &UPlayFabServerAPI::HelperLinkNintendoServiceAccount);

    // Setup the request
    manager->SetCallAuthenticationContext(request.AuthenticationContext);
    manager->PlayFabRequestURL = "/Server/LinkNintendoServiceAccount";
    manager->useSecretKey = true;
...
// Implements FOnPlayFabServerRequestCompleted
void UPlayFabServerAPI::HelperLinkNintendoServiceAccount(FPlayFabBaseModel response, UObject* customData, bool successful)
{
    FPlayFabError error = response.responseError;
    if (error.hasError && OnFailure.IsBound())
    {
...
UPlayFabServerAPI* UPlayFabServerAPI::LinkNintendoServiceAccountSubject(FServerLinkNintendoServiceAccountSubjectRequest request,
    FDelegateOnSuccessLinkNintendoServiceAccountSubject onSuccess,
    FDelegateOnFailurePlayFabError onFailure,
    UObject* customData)
{
    // Objects containing request data
    ...
    // Assign delegates
    manager->OnSuccessLinkNintendoServiceAccountSubject = onSuccess;
    manager->OnFailure = onFailure;
    manager->OnPlayFabResponse.AddDynamic(manager, &UPlayFabServerAPI::HelperLinkNintendoServiceAccountSubject);

    // Setup the request
    manager->SetCallAuthenticationContext(request.AuthenticationContext);
    manager->PlayFabRequestURL = "/Server/LinkNintendoServiceAccountSubject";
    manager->useSecretKey = true;
...
// Implements FOnPlayFabServerRequestCompleted
void UPlayFabServerAPI::HelperLinkNintendoServiceAccountSubject(FPlayFabBaseModel response, UObject* customData, bool successful)
{
    FPlayFabError error = response.responseError;
    if (error.hasError && OnFailure.IsBound())
    {
    ...
    else if (!error.hasError && OnSuccessLinkNintendoServiceAccountSubject.IsBound())
    {
        FServerEmptyResult ResultStruct = UPlayFabServerModelDecoder::decodeEmptyResultResponse(response.responseData);
        ResultStruct.Request = RequestJsonObj;
        OnSuccessLinkNintendoServiceAccountSubject.Execute(ResultStruct, mCustomData);
    }
    this->RemoveFromRoot();
}

/** Links the NintendoSwitchDeviceId to the user's PlayFab account */
UPlayFabServerAPI* UPlayFabServerAPI::LinkNintendoSwitchDeviceId(FServerLinkNintendoSwitchDeviceIdRequest request,
    ...
    UObject* customData)
{
    ...
    manager->OnFailure = onFailure;
    manager->OnPlayFabResponse.AddDynamic(manager, &UPlayFabServerAPI::HelperLinkNintendoSwitchDeviceId);

    // Setup the request
    manager->SetCallAuthenticationContext(request.AuthenticationContext);
    manager->PlayFabRequestURL = "/Server/LinkNintendoSwitchDeviceId";
    manager->useSecretKey = true;
...
// Implements FOnPlayFabServerRequestCompleted
void UPlayFabServerAPI::HelperLinkNintendoSwitchDeviceId(FPlayFabBaseModel response, UObject* customData, bool successful)
{
    FPlayFabError error = response.responseError;
    if (error.hasError && OnFailure.IsBound())
    {
    ...
    {
        FServerLinkNintendoSwitchDeviceIdResult ResultStruct = UPlayFabServerModelDecoder::decodeLinkNintendoSwitchDeviceIdResultResponse(response.responseData);
...
UPlayFabServerAPI* UPlayFabServerAPI::LinkPSNId(FServerLinkPSNIdRequest request,
    FDelegateOnSuccessLinkPSNId onSuccess,
    FDelegateOnFailurePlayFabError onFailure,
    UObject* customData)
{
    // Objects containing request data
    ...
    // Assign delegates
    manager->OnSuccessLinkPSNId = onSuccess;
    manager->OnFailure = onFailure;
    manager->OnPlayFabResponse.AddDynamic(manager, &UPlayFabServerAPI::HelperLinkPSNId);

    // Setup the request
    manager->SetCallAuthenticationContext(request.AuthenticationContext);
    manager->PlayFabRequestURL = "/Server/LinkPSNId";
    manager->useSecretKey = true;
    ...
    if (request.PSNUserId.IsEmpty() || request.PSNUserId == "") {
...
// Implements FOnPlayFabServerRequestCompleted
void UPlayFabServerAPI::HelperLinkPSNId(FPlayFabBaseModel response, UObject* customData, bool successful)
{
    FPlayFabError error = response.responseError;
    if (error.hasError && OnFailure.IsBound())
    {
    ...
    else if (!error.hasError && OnSuccessLinkPSNId.IsBound())
    {
        FServerLinkPSNIdResponse ResultStruct = UPlayFabServerModelDecoder::decodeLinkPSNIdResponseResponse(response.responseData);
        OnSuccessLinkPSNId.Execute(ResultStruct, mCustomData);
    }
    this->RemoveFromRoot();
}
...
UPlayFabServerAPI* UPlayFabServerAPI::LinkXboxId(FServerLinkXboxIdRequest request,
    ...
    UObject* customData)
{
    ...
    // Assign delegates
    manager->OnSuccessLinkXboxId = onSuccess;
    manager->OnFailure = onFailure;
    manager->OnPlayFabResponse.AddDynamic(manager, &UPlayFabServerAPI::HelperLinkXboxId);

    // Setup the request
    manager->SetCallAuthenticationContext(request.AuthenticationContext);
    manager->PlayFabRequestURL = "/Server/LinkXboxId";
    manager->useSecretKey = true;
...
// Implements FOnPlayFabServerRequestCompleted
void UPlayFabServerAPI::HelperLinkXboxId(FPlayFabBaseModel response, UObject* customData, bool successful)
{
    FPlayFabError error = response.responseError;
    if (error.hasError && OnFailure.IsBound())
    {
    ...
    else if (!error.hasError && OnSuccessLinkXboxId.IsBound())
    {
        FServerLinkXboxAccountResult ResultStruct = UPlayFabServerModelDecoder::decodeLinkXboxAccountResultResponse(response.responseData);
        ResultStruct.Request = RequestJsonObj;
        OnSuccessLinkXboxId.Execute(ResultStruct, mCustomData);
    }
    this->RemoveFromRoot();
}
    ...
    UObject* customData)
{
    ...
    manager->OnFailure = onFailure;
    manager->OnPlayFabResponse.AddDynamic(manager, &UPlayFabServerAPI::HelperUnlinkNintendoServiceAccount);

    // Setup the request
    manager->SetCallAuthenticationContext(request.AuthenticationContext);
    manager->PlayFabRequestURL = "/Server/UnlinkNintendoServiceAccount";
    manager->useSecretKey = true;
...
// Implements FOnPlayFabServerRequestCompleted
void UPlayFabServerAPI::HelperUnlinkNintendoServiceAccount(FPlayFabBaseModel response, UObject* customData, bool successful)
{
    FPlayFabError error = response.responseError;
    if (error.hasError && OnFailure.IsBound())
    {
...
UPlayFabServerAPI* UPlayFabServerAPI::UnlinkNintendoSwitchDeviceId(FServerUnlinkNintendoSwitchDeviceIdRequest request,
    ...
    UObject* customData)
{
    ...
    manager->OnFailure = onFailure;
    manager->OnPlayFabResponse.AddDynamic(manager, &UPlayFabServerAPI::HelperUnlinkNintendoSwitchDeviceId);

    // Setup the request
    manager->SetCallAuthenticationContext(request.AuthenticationContext);
    manager->PlayFabRequestURL = "/Server/UnlinkNintendoSwitchDeviceId";
    manager->useSecretKey = true;
...
// Implements FOnPlayFabServerRequestCompleted
void UPlayFabServerAPI::HelperUnlinkNintendoSwitchDeviceId(FPlayFabBaseModel response, UObject* customData, bool successful)
{
    FPlayFabError error = response.responseError;
    if (error.hasError && OnFailure.IsBound())
    {
    ...
    {
        FServerUnlinkNintendoSwitchDeviceIdResult ResultStruct = UPlayFabServerModelDecoder::decodeUnlinkNintendoSwitchDeviceIdResultResponse(response.responseData);
    ...
    UObject* customData)
{
    ...
    OutRestJsonObj->SetBoolField(TEXT("NamespaceWide"), request.NamespaceWide);
    if (request.PlayFabId.IsEmpty() || request.PlayFabId == "") {
        OutRestJsonObj->SetFieldNull(TEXT("PlayFabId"));
    } else {
        OutRestJsonObj->SetStringField(TEXT("PlayFabId"), request.PlayFabId);
...
UPlayFabServerAPI* UPlayFabServerAPI::GetSegmentPlayerCount(FServerGetSegmentPlayerCountRequest request,
    ...
    UObject* customData)
{
    ...
    manager->OnFailure = onFailure;
    manager->OnPlayFabResponse.AddDynamic(manager, &UPlayFabServerAPI::HelperGetSegmentPlayerCount);

    // Setup the request
    manager->SetCallAuthenticationContext(request.AuthenticationContext);
    manager->PlayFabRequestURL = "/Server/GetSegmentPlayerCount";
    manager->useSecretKey = true;
...
// Implements FOnPlayFabServerRequestCompleted
void UPlayFabServerAPI::HelperGetSegmentPlayerCount(FPlayFabBaseModel response, UObject* customData, bool successful)
{
    FPlayFabError error = response.responseError;
    if (error.hasError && OnFailure.IsBound())
    {
    ...
    {
        FServerGetSegmentPlayerCountResult ResultStruct = UPlayFabServerModelDecoder::decodeGetSegmentPlayerCountResultResponse(response.responseData);
