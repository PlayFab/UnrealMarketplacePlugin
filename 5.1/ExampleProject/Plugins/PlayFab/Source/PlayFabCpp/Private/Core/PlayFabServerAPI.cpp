...
bool UPlayFabServerAPI::AddOrUpdateContactEmail(
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/AddOrUpdateContactEmail"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnAddOrUpdateContactEmailResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnAddOrUpdateContactEmailResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FAddOrUpdateContactEmailDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
...
bool UPlayFabServerAPI::DeletePlayerCustomProperties(
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/DeletePlayerCustomProperties"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnDeletePlayerCustomPropertiesResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnDeletePlayerCustomPropertiesResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FDeletePlayerCustomPropertiesDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
...
bool UPlayFabServerAPI::ExportPlayersInSegment(
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/ExportPlayersInSegment"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnExportPlayersInSegmentResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnExportPlayersInSegmentResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FExportPlayersInSegmentDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
...
bool UPlayFabServerAPI::GetPlayerCustomProperty(
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/GetPlayerCustomProperty"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnGetPlayerCustomPropertyResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnGetPlayerCustomPropertyResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FGetPlayerCustomPropertyDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
...
bool UPlayFabServerAPI::GetPlayFabIDsFromBattleNetAccountIds(
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/GetPlayFabIDsFromBattleNetAccountIds"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnGetPlayFabIDsFromBattleNetAccountIdsResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnGetPlayFabIDsFromBattleNetAccountIdsResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FGetPlayFabIDsFromBattleNetAccountIdsDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
...
bool UPlayFabServerAPI::GetPlayFabIDsFromNintendoServiceAccountIds(
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/GetPlayFabIDsFromNintendoServiceAccountIds"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnGetPlayFabIDsFromNintendoServiceAccountIdsResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnGetPlayFabIDsFromNintendoServiceAccountIdsResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FGetPlayFabIDsFromNintendoServiceAccountIdsDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
...
bool UPlayFabServerAPI::GetPlayFabIDsFromOpenIdSubjectIdentifiers(
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/GetPlayFabIDsFromOpenIdSubjectIdentifiers"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnGetPlayFabIDsFromOpenIdSubjectIdentifiersResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnGetPlayFabIDsFromOpenIdSubjectIdentifiersResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FGetPlayFabIDsFromOpenIdSubjectIdentifiersDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
...
bool UPlayFabServerAPI::GetPlayFabIDsFromPSNOnlineIDs(
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/GetPlayFabIDsFromPSNOnlineIDs"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnGetPlayFabIDsFromPSNOnlineIDsResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnGetPlayFabIDsFromPSNOnlineIDsResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FGetPlayFabIDsFromPSNOnlineIDsDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
...
bool UPlayFabServerAPI::GetPlayFabIDsFromServerCustomIDs(
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/GetPlayFabIDsFromServerCustomIDs"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnGetPlayFabIDsFromServerCustomIDsResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnGetPlayFabIDsFromServerCustomIDsResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FGetPlayFabIDsFromServerCustomIDsDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/GetPlayFabIDsFromTwitchIDs"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnGetPlayFabIDsFromTwitchIDsResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnGetPlayFabIDsFromTwitchIDsResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FGetPlayFabIDsFromTwitchIDsDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
...
bool UPlayFabServerAPI::GetSegmentExport(
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/GetSegmentExport"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnGetSegmentExportResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnGetSegmentExportResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FGetSegmentExportDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
...
bool UPlayFabServerAPI::GetSegmentPlayerCount(
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/GetSegmentPlayerCount"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnGetSegmentPlayerCountResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnGetSegmentPlayerCountResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FGetSegmentPlayerCountDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
...
bool UPlayFabServerAPI::LinkBattleNetAccount(
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/LinkBattleNetAccount"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnLinkBattleNetAccountResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnLinkBattleNetAccountResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FLinkBattleNetAccountDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
    ServerModels::FEmptyResult outResult;
    FPlayFabCppError errorResult;
    if (PlayFabRequestHandler::DecodeRequest(HttpRequest, HttpResponse, bSucceeded, outResult, errorResult))
...
bool UPlayFabServerAPI::LinkNintendoServiceAccount(
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/LinkNintendoServiceAccount"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnLinkNintendoServiceAccountResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnLinkNintendoServiceAccountResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FLinkNintendoServiceAccountDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
    ServerModels::FEmptyResult outResult;
    FPlayFabCppError errorResult;
    if (PlayFabRequestHandler::DecodeRequest(HttpRequest, HttpResponse, bSucceeded, outResult, errorResult))
...
bool UPlayFabServerAPI::LinkNintendoServiceAccountSubject(
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/LinkNintendoServiceAccountSubject"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnLinkNintendoServiceAccountSubjectResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnLinkNintendoServiceAccountSubjectResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FLinkNintendoServiceAccountSubjectDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
    ServerModels::FEmptyResult outResult;
    FPlayFabCppError errorResult;
    if (PlayFabRequestHandler::DecodeRequest(HttpRequest, HttpResponse, bSucceeded, outResult, errorResult))
...
bool UPlayFabServerAPI::LinkNintendoSwitchDeviceId(
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/LinkNintendoSwitchDeviceId"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnLinkNintendoSwitchDeviceIdResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnLinkNintendoSwitchDeviceIdResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FLinkNintendoSwitchDeviceIdDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
...
bool UPlayFabServerAPI::LinkPSNId(
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/LinkPSNId"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnLinkPSNIdResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnLinkPSNIdResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FLinkPSNIdDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
...
bool UPlayFabServerAPI::LinkSteamId(
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/LinkSteamId"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnLinkSteamIdResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnLinkSteamIdResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FLinkSteamIdDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
...
bool UPlayFabServerAPI::LinkTwitchAccount(
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/LinkTwitchAccount"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnLinkTwitchAccountResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnLinkTwitchAccountResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FLinkTwitchAccountDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
    ServerModels::FEmptyResult outResult;
    FPlayFabCppError errorResult;
    if (PlayFabRequestHandler::DecodeRequest(HttpRequest, HttpResponse, bSucceeded, outResult, errorResult))
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/ListPlayerCustomProperties"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnListPlayerCustomPropertiesResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnListPlayerCustomPropertiesResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FListPlayerCustomPropertiesDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
...
bool UPlayFabServerAPI::LoginWithAndroidDeviceID(
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/LoginWithAndroidDeviceID"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnLoginWithAndroidDeviceIDResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnLoginWithAndroidDeviceIDResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FLoginWithAndroidDeviceIDDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
...
bool UPlayFabServerAPI::LoginWithBattleNet(
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/LoginWithBattleNet"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnLoginWithBattleNetResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnLoginWithBattleNetResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FLoginWithBattleNetDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
    ServerModels::FServerLoginResult outResult;
    FPlayFabCppError errorResult;
    if (PlayFabRequestHandler::DecodeRequest(HttpRequest, HttpResponse, bSucceeded, outResult, errorResult))
...
bool UPlayFabServerAPI::LoginWithCustomID(
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/LoginWithCustomID"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnLoginWithCustomIDResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnLoginWithCustomIDResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FLoginWithCustomIDDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
    ServerModels::FServerLoginResult outResult;
    FPlayFabCppError errorResult;
    if (PlayFabRequestHandler::DecodeRequest(HttpRequest, HttpResponse, bSucceeded, outResult, errorResult))
...
bool UPlayFabServerAPI::LoginWithIOSDeviceID(
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/LoginWithIOSDeviceID"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnLoginWithIOSDeviceIDResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnLoginWithIOSDeviceIDResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FLoginWithIOSDeviceIDDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
    ServerModels::FServerLoginResult outResult;
    FPlayFabCppError errorResult;
    if (PlayFabRequestHandler::DecodeRequest(HttpRequest, HttpResponse, bSucceeded, outResult, errorResult))
...
bool UPlayFabServerAPI::LoginWithPSN(
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/LoginWithPSN"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnLoginWithPSNResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnLoginWithPSNResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FLoginWithPSNDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
    ServerModels::FServerLoginResult outResult;
    FPlayFabCppError errorResult;
    if (PlayFabRequestHandler::DecodeRequest(HttpRequest, HttpResponse, bSucceeded, outResult, errorResult))
...
bool UPlayFabServerAPI::LoginWithTwitch(
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/LoginWithTwitch"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnLoginWithTwitchResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnLoginWithTwitchResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FLoginWithTwitchDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
    ServerModels::FServerLoginResult outResult;
    FPlayFabCppError errorResult;
    if (PlayFabRequestHandler::DecodeRequest(HttpRequest, HttpResponse, bSucceeded, outResult, errorResult))
...
bool UPlayFabServerAPI::UnlinkApple(
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/UnlinkApple"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnUnlinkAppleResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnUnlinkAppleResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FUnlinkAppleDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
...
bool UPlayFabServerAPI::UnlinkBattleNetAccount(
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/UnlinkBattleNetAccount"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnUnlinkBattleNetAccountResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnUnlinkBattleNetAccountResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FUnlinkBattleNetAccountDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
    ServerModels::FEmptyResponse outResult;
    FPlayFabCppError errorResult;
    if (PlayFabRequestHandler::DecodeRequest(HttpRequest, HttpResponse, bSucceeded, outResult, errorResult))
...
bool UPlayFabServerAPI::UnlinkFacebookAccount(
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/UnlinkFacebookAccount"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnUnlinkFacebookAccountResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnUnlinkFacebookAccountResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FUnlinkFacebookAccountDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
...
bool UPlayFabServerAPI::UnlinkFacebookInstantGamesId(
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/UnlinkFacebookInstantGamesId"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnUnlinkFacebookInstantGamesIdResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnUnlinkFacebookInstantGamesIdResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FUnlinkFacebookInstantGamesIdDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
...
bool UPlayFabServerAPI::UnlinkGameCenterAccount(
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/UnlinkGameCenterAccount"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnUnlinkGameCenterAccountResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnUnlinkGameCenterAccountResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FUnlinkGameCenterAccountDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
...
bool UPlayFabServerAPI::UnlinkNintendoServiceAccount(
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/UnlinkNintendoServiceAccount"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnUnlinkNintendoServiceAccountResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnUnlinkNintendoServiceAccountResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FUnlinkNintendoServiceAccountDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
    ServerModels::FEmptyResponse outResult;
    FPlayFabCppError errorResult;
    if (PlayFabRequestHandler::DecodeRequest(HttpRequest, HttpResponse, bSucceeded, outResult, errorResult))
...
bool UPlayFabServerAPI::UnlinkNintendoSwitchDeviceId(
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/UnlinkNintendoSwitchDeviceId"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnUnlinkNintendoSwitchDeviceIdResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnUnlinkNintendoSwitchDeviceIdResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FUnlinkNintendoSwitchDeviceIdDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
...
bool UPlayFabServerAPI::UnlinkSteamId(
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/UnlinkSteamId"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnUnlinkSteamIdResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnUnlinkSteamIdResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FUnlinkSteamIdDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
...
bool UPlayFabServerAPI::UnlinkTwitchAccount(
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/UnlinkTwitchAccount"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnUnlinkTwitchAccountResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnUnlinkTwitchAccountResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FUnlinkTwitchAccountDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
    ServerModels::FEmptyResult outResult;
    FPlayFabCppError errorResult;
    if (PlayFabRequestHandler::DecodeRequest(HttpRequest, HttpResponse, bSucceeded, outResult, errorResult))
...
bool UPlayFabServerAPI::UpdatePlayerCustomProperties(
    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(nullptr, TEXT("/Server/UpdatePlayerCustomProperties"), request.toJSONString(), TEXT("X-SecretKey"), devSecretKey);
    HttpRequest->OnProcessRequestComplete().BindRaw(this, &UPlayFabServerAPI::OnUpdatePlayerCustomPropertiesResult, SuccessDelegate, ErrorDelegate);
    return HttpRequest->ProcessRequest();
}

void UPlayFabServerAPI::OnUpdatePlayerCustomPropertiesResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FUpdatePlayerCustomPropertiesDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate)
{
