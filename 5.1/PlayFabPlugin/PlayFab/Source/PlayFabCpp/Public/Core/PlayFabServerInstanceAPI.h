...
namespace PlayFab
{
    ...
    public:
        ...
        DECLARE_DELEGATE_OneParam(FDeletePlayerCustomPropertiesDelegate, const ServerModels::FDeletePlayerCustomPropertiesResult&);
        ...
        DECLARE_DELEGATE_OneParam(FGetPlayFabIDsFromOpenIdSubjectIdentifiersDelegate, const ServerModels::FGetPlayFabIDsFromOpenIdsResult&);
        ...
        DECLARE_DELEGATE_OneParam(FGetPlayFabIDsFromPSNOnlineIDsDelegate, const ServerModels::FGetPlayFabIDsFromPSNOnlineIDsResult&);
        DECLARE_DELEGATE_OneParam(FGetPlayFabIDsFromServerCustomIDsDelegate, const ServerModels::FGetPlayFabIDsFromServerCustomIDsResult&);
        DECLARE_DELEGATE_OneParam(FGetPlayFabIDsFromSteamIDsDelegate, const ServerModels::FGetPlayFabIDsFromSteamIDsResult&);
        DECLARE_DELEGATE_OneParam(FGetPlayFabIDsFromSteamNamesDelegate, const ServerModels::FGetPlayFabIDsFromSteamNamesResult&);
        ...
        DECLARE_DELEGATE_OneParam(FGetSegmentPlayerCountDelegate, const ServerModels::FGetSegmentPlayerCountResult&);
        ...
        DECLARE_DELEGATE_OneParam(FLinkTwitchAccountDelegate, const ServerModels::FEmptyResult&);
        ...
        DECLARE_DELEGATE_OneParam(FLoginWithTwitchDelegate, const ServerModels::FServerLoginResult&);
        ...
        DECLARE_DELEGATE_OneParam(FUnlinkSteamIdDelegate, const ServerModels::FUnlinkSteamIdResult&);
        DECLARE_DELEGATE_OneParam(FUnlinkTwitchAccountDelegate, const ServerModels::FEmptyResult&);
        ...
        DECLARE_DELEGATE_OneParam(FUpdatePlayerCustomPropertiesDelegate, const ServerModels::FUpdatePlayerCustomPropertiesResult&);
    ...
    public:
         ...
         */
        bool DeletePlayerCustomProperties(ServerModels::FDeletePlayerCustomPropertiesRequest& request, const FDeletePlayerCustomPropertiesDelegate& SuccessDelegate = FDeletePlayerCustomPropertiesDelegate(), const FPlayFabErrorDelegate& ErrorDelegate = FPlayFabErrorDelegate());
        ...
        bool GetPlayerCustomProperty(ServerModels::FGetPlayerCustomPropertyRequest& request, const FGetPlayerCustomPropertyDelegate& SuccessDelegate = FGetPlayerCustomPropertyDelegate(), const FPlayFabErrorDelegate& ErrorDelegate = FPlayFabErrorDelegate());
        /**
         ...
         */
        bool GetPlayFabIDsFromOpenIdSubjectIdentifiers(ServerModels::FGetPlayFabIDsFromOpenIdsRequest& request, const FGetPlayFabIDsFromOpenIdSubjectIdentifiersDelegate& SuccessDelegate = FGetPlayFabIDsFromOpenIdSubjectIdentifiersDelegate(), const FPlayFabErrorDelegate& ErrorDelegate = FPlayFabErrorDelegate());
        ...
        // Retrieves the unique PlayFab identifiers for the given set of PlayStation :tm: Network identifiers.
        bool GetPlayFabIDsFromPSNOnlineIDs(ServerModels::FGetPlayFabIDsFromPSNOnlineIDsRequest& request, const FGetPlayFabIDsFromPSNOnlineIDsDelegate& SuccessDelegate = FGetPlayFabIDsFromPSNOnlineIDsDelegate(), const FPlayFabErrorDelegate& ErrorDelegate = FPlayFabErrorDelegate());
        // Retrieves the associated PlayFab account identifiers for the given set of server custom player identifiers.
        bool GetPlayFabIDsFromServerCustomIDs(ServerModels::FGetPlayFabIDsFromServerCustomIDsRequest& request, const FGetPlayFabIDsFromServerCustomIDsDelegate& SuccessDelegate = FGetPlayFabIDsFromServerCustomIDsDelegate(), const FPlayFabErrorDelegate& ErrorDelegate = FPlayFabErrorDelegate());
        /**
         ...
         * names.
         */
        bool GetPlayFabIDsFromSteamNames(ServerModels::FGetPlayFabIDsFromSteamNamesRequest& request, const FGetPlayFabIDsFromSteamNamesDelegate& SuccessDelegate = FGetPlayFabIDsFromSteamNamesDelegate(), const FPlayFabErrorDelegate& ErrorDelegate = FPlayFabErrorDelegate());
        /**
         ...
         */
        bool GetSegmentPlayerCount(ServerModels::FGetSegmentPlayerCountRequest& request, const FGetSegmentPlayerCountDelegate& SuccessDelegate = FGetSegmentPlayerCountDelegate(), const FPlayFabErrorDelegate& ErrorDelegate = FPlayFabErrorDelegate());
        ...
        bool LinkPSNId(ServerModels::FLinkPSNIdRequest& request, const FLinkPSNIdDelegate& SuccessDelegate = FLinkPSNIdDelegate(), const FPlayFabErrorDelegate& ErrorDelegate = FPlayFabErrorDelegate());
        ...
        bool LinkTwitchAccount(ServerModels::FLinkTwitchAccountRequest& request, const FLinkTwitchAccountDelegate& SuccessDelegate = FLinkTwitchAccountDelegate(), const FPlayFabErrorDelegate& ErrorDelegate = FPlayFabErrorDelegate());
         ...
         */
        bool LoginWithTwitch(ServerModels::FLoginWithTwitchRequest& request, const FLoginWithTwitchDelegate& SuccessDelegate = FLoginWithTwitchDelegate(), const FPlayFabErrorDelegate& ErrorDelegate = FPlayFabErrorDelegate());
        /**
        ...
        bool UnlinkNintendoSwitchDeviceId(ServerModels::FUnlinkNintendoSwitchDeviceIdRequest& request, const FUnlinkNintendoSwitchDeviceIdDelegate& SuccessDelegate = FUnlinkNintendoSwitchDeviceIdDelegate(), const FPlayFabErrorDelegate& ErrorDelegate = FPlayFabErrorDelegate());
        ...
        bool UnlinkSteamId(ServerModels::FUnlinkSteamIdRequest& request, const FUnlinkSteamIdDelegate& SuccessDelegate = FUnlinkSteamIdDelegate(), const FPlayFabErrorDelegate& ErrorDelegate = FPlayFabErrorDelegate());
        // Unlinks the related Twitch account from the user's PlayFab account.
        bool UnlinkTwitchAccount(ServerModels::FUnlinkTwitchAccountRequest& request, const FUnlinkTwitchAccountDelegate& SuccessDelegate = FUnlinkTwitchAccountDelegate(), const FPlayFabErrorDelegate& ErrorDelegate = FPlayFabErrorDelegate());
         ...
         */
        bool UpdatePlayerCustomProperties(ServerModels::FUpdatePlayerCustomPropertiesRequest& request, const FUpdatePlayerCustomPropertiesDelegate& SuccessDelegate = FUpdatePlayerCustomPropertiesDelegate(), const FPlayFabErrorDelegate& ErrorDelegate = FPlayFabErrorDelegate());
        /**
    ...
    private:
        ...
        void OnGetPlayFabIDsFromOpenIdSubjectIdentifiersResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FGetPlayFabIDsFromOpenIdSubjectIdentifiersDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate);
        ...
        void OnGetPlayFabIDsFromServerCustomIDsResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FGetPlayFabIDsFromServerCustomIDsDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate);
        ...
        void OnLinkTwitchAccountResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FLinkTwitchAccountDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate);
        ...
        void OnUnlinkSteamIdResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FUnlinkSteamIdDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate);
        void OnUnlinkTwitchAccountResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FUnlinkTwitchAccountDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate);
