...
FAddonGetNintendoResponse UPlayFabAddonModelDecoder::decodeGetNintendoResponseResponse(UPlayFabJsonObject* response)
{
    ...
    tempStruct.SecondarySubscriptionEnvironments = !(dataObj->HasField("SecondarySubscriptionEnvironments")) ? TArray<UPlayFabJsonObject*>() : dataObj->GetObjectArrayField("SecondarySubscriptionEnvironments");
