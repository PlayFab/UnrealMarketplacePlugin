 ...
 */
USTRUCT(BlueprintType)
struct PLAYFAB_API FAdminValidateApiPolicyRequest : public FPlayFabRequestCommon
{
    GENERATED_USTRUCT_BODY()
public:
...
USTRUCT(BlueprintType)
struct PLAYFAB_API FAdminValidateApiPolicyResponse : public FPlayFabResultCommon
{
    GENERATED_USTRUCT_BODY()
public:
