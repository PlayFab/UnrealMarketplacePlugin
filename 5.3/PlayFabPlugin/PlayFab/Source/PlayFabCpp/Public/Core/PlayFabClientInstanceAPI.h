...
namespace PlayFab
{
     ...
     */
    class PLAYFABCPP_API UPlayFabClientInstanceAPI
    {
    public:
        ...
        DECLARE_DELEGATE_OneParam(FGetPlayFabIDsFromOpenIdSubjectIdentifiersDelegate, const ClientModels::FGetPlayFabIDsFromOpenIdsResult&);
        ...
        DECLARE_DELEGATE_OneParam(FLinkBattleNetAccountDelegate, const ClientModels::FEmptyResponse&);
        ...
        DECLARE_DELEGATE_OneParam(FLoginWithGooglePlayGamesServicesDelegate, const ClientModels::FLoginResult&);
        ...
        DECLARE_DELEGATE_OneParam(FUnlinkBattleNetAccountDelegate, const ClientModels::FEmptyResponse&);
    ...
    public:
        UPlayFabClientInstanceAPI();
        explicit UPlayFabClientInstanceAPI(TSharedPtr<UPlayFabAPISettings> apiSettings);
        explicit UPlayFabClientInstanceAPI(TSharedPtr<UPlayFabAuthenticationContext> authenticationContext);
        UPlayFabClientInstanceAPI(TSharedPtr<UPlayFabAPISettings> apiSettings, TSharedPtr<UPlayFabAuthenticationContext> authenticationContext);
        ~UPlayFabClientInstanceAPI();
        UPlayFabClientInstanceAPI(const UPlayFabClientInstanceAPI& source) = delete; // disable copy
        UPlayFabClientInstanceAPI(UPlayFabClientInstanceAPI&&) = delete; // disable move
        UPlayFabClientInstanceAPI& operator=(const UPlayFabClientInstanceAPI& source) = delete; // disable assignment
        UPlayFabClientInstanceAPI& operator=(UPlayFabClientInstanceAPI&& other) = delete; // disable move assignment
    ...
    public:
         ...
         */
        bool GetPlayFabIDsFromOpenIdSubjectIdentifiers(ClientModels::FGetPlayFabIDsFromOpenIdsRequest& request, const FGetPlayFabIDsFromOpenIdSubjectIdentifiersDelegate& SuccessDelegate = FGetPlayFabIDsFromOpenIdSubjectIdentifiersDelegate(), const FPlayFabErrorDelegate& ErrorDelegate = FPlayFabErrorDelegate());
        ...
        // Retrieves the unique PlayFab identifiers for the given set of PlayStation :tm: Network identifiers.
        bool GetPlayFabIDsFromPSNOnlineIDs(ClientModels::FGetPlayFabIDsFromPSNOnlineIDsRequest& request, const FGetPlayFabIDsFromPSNOnlineIDsDelegate& SuccessDelegate = FGetPlayFabIDsFromPSNOnlineIDsDelegate(), const FPlayFabErrorDelegate& ErrorDelegate = FPlayFabErrorDelegate());
        /**
        ...
        bool LinkBattleNetAccount(ClientModels::FLinkBattleNetAccountRequest& request, const FLinkBattleNetAccountDelegate& SuccessDelegate = FLinkBattleNetAccountDelegate(), const FPlayFabErrorDelegate& ErrorDelegate = FPlayFabErrorDelegate());
         ...
         */
        bool LoginWithGooglePlayGamesServices(ClientModels::FLoginWithGooglePlayGamesServicesRequest& request, const FLoginWithGooglePlayGamesServicesDelegate& SuccessDelegate = FLoginWithGooglePlayGamesServicesDelegate(), const FPlayFabErrorDelegate& ErrorDelegate = FPlayFabErrorDelegate());
        /**
        ...
        bool UnlinkBattleNetAccount(ClientModels::FUnlinkBattleNetAccountRequest& request, const FUnlinkBattleNetAccountDelegate& SuccessDelegate = FUnlinkBattleNetAccountDelegate(), const FPlayFabErrorDelegate& ErrorDelegate = FPlayFabErrorDelegate());
    ...
    private:
        ...
        void OnLoginWithGooglePlayGamesServicesResult(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FLoginWithGooglePlayGamesServicesDelegate SuccessDelegate, FPlayFabErrorDelegate ErrorDelegate);
