...
{
    const FString PlayFabCommonSettings::sdkVersion = "1.184.260327";
    const FString PlayFabCommonSettings::buildIdentifier = "adobuild_unrealmarketplaceplugin_281";
    const FString PlayFabCommonSettings::versionString = "UE4MKPL-1.184.260327";
    const FString PlayFabCommonSettings::engineVersion = "5.5";
