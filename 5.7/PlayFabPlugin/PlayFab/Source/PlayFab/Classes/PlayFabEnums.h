...
enum class EAzureVmFamily : uint8
{
    ...
    pfenum_Dsv3 = 14 UMETA(DisplayName = "Dsv3"),
    pfenum_Dsv2 = 15 UMETA(DisplayName = "Dsv2"),
    pfenum_NCasT4_v3 = 16 UMETA(DisplayName = "NCasT4_v3"),
    pfenum_Ddv4 = 17 UMETA(DisplayName = "Ddv4"),
    pfenum_Ddsv4 = 18 UMETA(DisplayName = "Ddsv4"),
    pfenum_HBv3 = 19 UMETA(DisplayName = "HBv3"),
    pfenum_Ddv5 = 20 UMETA(DisplayName = "Ddv5"),
    pfenum_Ddsv5 = 21 UMETA(DisplayName = "Ddsv5"),
    pfenum_Ddsv6 = 22 UMETA(DisplayName = "Ddsv6"),
    pfenum_Fasv6 = 23 UMETA(DisplayName = "Fasv6"),
    pfenum_Fasv7 = 24 UMETA(DisplayName = "Fasv7"),
    pfenum_Fadsv7 = 25 UMETA(DisplayName = "Fadsv7"),
    pfenum_Eadsv5 = 26 UMETA(DisplayName = "Eadsv5"),
    pfenum_Eadsv6 = 27 UMETA(DisplayName = "Eadsv6"),
    pfenum_Eadsv7 = 28 UMETA(DisplayName = "Eadsv7"),
    pfenum_Dadsv7 = 29 UMETA(DisplayName = "Dadsv7"),
};
...
enum class EAzureVmSize : uint8
{
    ...
    pfenum_Standard_D2s_v3 = 78 UMETA(DisplayName = "Standard_D2s_v3"),
    pfenum_Standard_D4s_v3 = 79 UMETA(DisplayName = "Standard_D4s_v3"),
    pfenum_Standard_D8s_v3 = 80 UMETA(DisplayName = "Standard_D8s_v3"),
    pfenum_Standard_D16s_v3 = 81 UMETA(DisplayName = "Standard_D16s_v3"),
    pfenum_Standard_DS1_v2 = 82 UMETA(DisplayName = "Standard_DS1_v2"),
    pfenum_Standard_DS2_v2 = 83 UMETA(DisplayName = "Standard_DS2_v2"),
    pfenum_Standard_DS3_v2 = 84 UMETA(DisplayName = "Standard_DS3_v2"),
    pfenum_Standard_DS4_v2 = 85 UMETA(DisplayName = "Standard_DS4_v2"),
    pfenum_Standard_DS5_v2 = 86 UMETA(DisplayName = "Standard_DS5_v2"),
    pfenum_Standard_NC4as_T4_v3 = 87 UMETA(DisplayName = "Standard_NC4as_T4_v3"),
    pfenum_Standard_D2d_v4 = 88 UMETA(DisplayName = "Standard_D2d_v4"),
    pfenum_Standard_D4d_v4 = 89 UMETA(DisplayName = "Standard_D4d_v4"),
    pfenum_Standard_D8d_v4 = 90 UMETA(DisplayName = "Standard_D8d_v4"),
    pfenum_Standard_D16d_v4 = 91 UMETA(DisplayName = "Standard_D16d_v4"),
    pfenum_Standard_D2ds_v4 = 92 UMETA(DisplayName = "Standard_D2ds_v4"),
    pfenum_Standard_D4ds_v4 = 93 UMETA(DisplayName = "Standard_D4ds_v4"),
    pfenum_Standard_D8ds_v4 = 94 UMETA(DisplayName = "Standard_D8ds_v4"),
    pfenum_Standard_D16ds_v4 = 95 UMETA(DisplayName = "Standard_D16ds_v4"),
    pfenum_Standard_HB120_16rs_v3 = 96 UMETA(DisplayName = "Standard_HB120_16rs_v3"),
    pfenum_Standard_HB120_32rs_v3 = 97 UMETA(DisplayName = "Standard_HB120_32rs_v3"),
    pfenum_Standard_HB120_64rs_v3 = 98 UMETA(DisplayName = "Standard_HB120_64rs_v3"),
    pfenum_Standard_HB120_96rs_v3 = 99 UMETA(DisplayName = "Standard_HB120_96rs_v3"),
    pfenum_Standard_HB120rs_v3 = 100 UMETA(DisplayName = "Standard_HB120rs_v3"),
    pfenum_Standard_D2d_v5 = 101 UMETA(DisplayName = "Standard_D2d_v5"),
    pfenum_Standard_D4d_v5 = 102 UMETA(DisplayName = "Standard_D4d_v5"),
    pfenum_Standard_D8d_v5 = 103 UMETA(DisplayName = "Standard_D8d_v5"),
    pfenum_Standard_D16d_v5 = 104 UMETA(DisplayName = "Standard_D16d_v5"),
    pfenum_Standard_D32d_v5 = 105 UMETA(DisplayName = "Standard_D32d_v5"),
    pfenum_Standard_D2ds_v5 = 106 UMETA(DisplayName = "Standard_D2ds_v5"),
    pfenum_Standard_D4ds_v5 = 107 UMETA(DisplayName = "Standard_D4ds_v5"),
    pfenum_Standard_D8ds_v5 = 108 UMETA(DisplayName = "Standard_D8ds_v5"),
    pfenum_Standard_D16ds_v5 = 109 UMETA(DisplayName = "Standard_D16ds_v5"),
    pfenum_Standard_D32ds_v5 = 110 UMETA(DisplayName = "Standard_D32ds_v5"),
    pfenum_Standard_D2ds_v6 = 111 UMETA(DisplayName = "Standard_D2ds_v6"),
    pfenum_Standard_D4ds_v6 = 112 UMETA(DisplayName = "Standard_D4ds_v6"),
    pfenum_Standard_D8ds_v6 = 113 UMETA(DisplayName = "Standard_D8ds_v6"),
    pfenum_Standard_D16ds_v6 = 114 UMETA(DisplayName = "Standard_D16ds_v6"),
};
