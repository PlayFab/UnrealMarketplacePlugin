...
PlayFab::AdminModels::FAddInventoryItemV2Content::~FAddInventoryItemV2Content()
{

}

void PlayFab::AdminModels::FAddInventoryItemV2Content::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
...
bool PlayFab::AdminModels::FAddInventoryItemV2Content::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
...
PlayFab::AdminModels::FBanPlayerContent::~FBanPlayerContent()
{

}

void PlayFab::AdminModels::FBanPlayerContent::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
    ...
    {
        writer->WriteIdentifierPrefix(TEXT("BanReason"));
        writer->WriteValue(BanReason);
    }

    writer->WriteObjectEnd();
}

bool PlayFab::AdminModels::FBanPlayerContent::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;

    const TSharedPtr<FJsonValue> BanDurationHoursValue = obj->TryGetField(TEXT("BanDurationHours"));
    if (BanDurationHoursValue.IsValid() && !BanDurationHoursValue->IsNull())
    {
        int32 TmpValue;
        if (BanDurationHoursValue->TryGetNumber(TmpValue)) { BanDurationHours = TmpValue; }
    }

    const TSharedPtr<FJsonValue> BanReasonValue = obj->TryGetField(TEXT("BanReason"));
    if (BanReasonValue.IsValid() && !BanReasonValue->IsNull())
    {
        FString TmpValue;
        if (BanReasonValue->TryGetString(TmpValue)) { BanReason = TmpValue; }
    }

    return HasSucceeded;
}

PlayFab::AdminModels::FDeleteInventoryItemV2Content::~FDeleteInventoryItemV2Content()
{

}

void PlayFab::AdminModels::FDeleteInventoryItemV2Content::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
...
bool PlayFab::AdminModels::FDeleteInventoryItemV2Content::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
...
PlayFab::AdminModels::FDeletePlayerContent::~FDeletePlayerContent()
{

}

void PlayFab::AdminModels::FDeletePlayerContent::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
...
bool PlayFab::AdminModels::FDeletePlayerContent::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
...
PlayFab::AdminModels::FExecuteCloudScriptContent::~FExecuteCloudScriptContent()
{

}

void PlayFab::AdminModels::FExecuteCloudScriptContent::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();

    if (!CloudScriptMethodArguments.IsEmpty() == false)
    {
        UE_LOG(LogTemp, Error, TEXT("This field is required: ExecuteCloudScriptContent::CloudScriptMethodArguments, PlayFab calls may not work if it remains empty."));
    }
    else
    {
        writer->WriteIdentifierPrefix(TEXT("CloudScriptMethodArguments"));
        writer->WriteValue(CloudScriptMethodArguments);
    }

    if (!CloudScriptMethodName.IsEmpty() == false)
    {
        UE_LOG(LogTemp, Error, TEXT("This field is required: ExecuteCloudScriptContent::CloudScriptMethodName, PlayFab calls may not work if it remains empty."));
    }
    else
    {
        writer->WriteIdentifierPrefix(TEXT("CloudScriptMethodName"));
        writer->WriteValue(CloudScriptMethodName);
    }

    writer->WriteIdentifierPrefix(TEXT("PublishResultsToPlayStream"));
    writer->WriteValue(PublishResultsToPlayStream);

    writer->WriteObjectEnd();
}

bool PlayFab::AdminModels::FExecuteCloudScriptContent::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;

    const TSharedPtr<FJsonValue> CloudScriptMethodArgumentsValue = obj->TryGetField(TEXT("CloudScriptMethodArguments"));
    if (CloudScriptMethodArgumentsValue.IsValid() && !CloudScriptMethodArgumentsValue->IsNull())
    {
        FString TmpValue;
        if (CloudScriptMethodArgumentsValue->TryGetString(TmpValue)) { CloudScriptMethodArguments = TmpValue; }
    }

    const TSharedPtr<FJsonValue> CloudScriptMethodNameValue = obj->TryGetField(TEXT("CloudScriptMethodName"));
    if (CloudScriptMethodNameValue.IsValid() && !CloudScriptMethodNameValue->IsNull())
    {
        FString TmpValue;
        if (CloudScriptMethodNameValue->TryGetString(TmpValue)) { CloudScriptMethodName = TmpValue; }
    }

    const TSharedPtr<FJsonValue> PublishResultsToPlayStreamValue = obj->TryGetField(TEXT("PublishResultsToPlayStream"));
    if (PublishResultsToPlayStreamValue.IsValid() && !PublishResultsToPlayStreamValue->IsNull())
    {
        bool TmpValue;
        if (PublishResultsToPlayStreamValue->TryGetBool(TmpValue)) { PublishResultsToPlayStream = TmpValue; }
    }

    return HasSucceeded;
}

PlayFab::AdminModels::FExecuteFunctionContent::~FExecuteFunctionContent()
{

}

void PlayFab::AdminModels::FExecuteFunctionContent::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();

    if (!CloudScriptFunctionArguments.IsEmpty() == false)
    {
        UE_LOG(LogTemp, Error, TEXT("This field is required: ExecuteFunctionContent::CloudScriptFunctionArguments, PlayFab calls may not work if it remains empty."));
    }
    else
    {
        writer->WriteIdentifierPrefix(TEXT("CloudScriptFunctionArguments"));
        writer->WriteValue(CloudScriptFunctionArguments);
    }

    if (!CloudScriptFunctionName.IsEmpty() == false)
    {
        UE_LOG(LogTemp, Error, TEXT("This field is required: ExecuteFunctionContent::CloudScriptFunctionName, PlayFab calls may not work if it remains empty."));
    }
    else
    {
        writer->WriteIdentifierPrefix(TEXT("CloudScriptFunctionName"));
        writer->WriteValue(CloudScriptFunctionName);
    }
...
bool PlayFab::AdminModels::FExecuteFunctionContent::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;

    const TSharedPtr<FJsonValue> CloudScriptFunctionArgumentsValue = obj->TryGetField(TEXT("CloudScriptFunctionArguments"));
    if (CloudScriptFunctionArgumentsValue.IsValid() && !CloudScriptFunctionArgumentsValue->IsNull())
    {
        FString TmpValue;
        if (CloudScriptFunctionArgumentsValue->TryGetString(TmpValue)) { CloudScriptFunctionArguments = TmpValue; }
    }

    const TSharedPtr<FJsonValue> CloudScriptFunctionNameValue = obj->TryGetField(TEXT("CloudScriptFunctionName"));
    if (CloudScriptFunctionNameValue.IsValid() && !CloudScriptFunctionNameValue->IsNull())
    {
        FString TmpValue;
        if (CloudScriptFunctionNameValue->TryGetString(TmpValue)) { CloudScriptFunctionName = TmpValue; }
    }
...
PlayFab::AdminModels::FGrantItemContent::~FGrantItemContent()
{

}

void PlayFab::AdminModels::FGrantItemContent::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
    ...
    writer->WriteIdentifierPrefix(TEXT("ItemQuantity"));
    writer->WriteValue(ItemQuantity);

    writer->WriteObjectEnd();
}

bool PlayFab::AdminModels::FGrantItemContent::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
    ...
    const TSharedPtr<FJsonValue> ItemQuantityValue = obj->TryGetField(TEXT("ItemQuantity"));
    if (ItemQuantityValue.IsValid() && !ItemQuantityValue->IsNull())
    {
        int32 TmpValue;
        if (ItemQuantityValue->TryGetNumber(TmpValue)) { ItemQuantity = TmpValue; }
    }

    return HasSucceeded;
}

PlayFab::AdminModels::FGrantVirtualCurrencyContent::~FGrantVirtualCurrencyContent()
{

}

void PlayFab::AdminModels::FGrantVirtualCurrencyContent::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();

    writer->WriteIdentifierPrefix(TEXT("CurrencyAmount"));
    writer->WriteValue(CurrencyAmount);

    if (!CurrencyCode.IsEmpty() == false)
    {
        UE_LOG(LogTemp, Error, TEXT("This field is required: GrantVirtualCurrencyContent::CurrencyCode, PlayFab calls may not work if it remains empty."));
    }
    else
    {
...
bool PlayFab::AdminModels::FGrantVirtualCurrencyContent::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;

    const TSharedPtr<FJsonValue> CurrencyAmountValue = obj->TryGetField(TEXT("CurrencyAmount"));
    if (CurrencyAmountValue.IsValid() && !CurrencyAmountValue->IsNull())
    {
        int32 TmpValue;
        if (CurrencyAmountValue->TryGetNumber(TmpValue)) { CurrencyAmount = TmpValue; }
    }
...
PlayFab::AdminModels::FIncrementPlayerStatisticContent::~FIncrementPlayerStatisticContent()
{

}

void PlayFab::AdminModels::FIncrementPlayerStatisticContent::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();

    writer->WriteIdentifierPrefix(TEXT("StatisticChangeBy"));
    writer->WriteValue(StatisticChangeBy);

    if (!StatisticName.IsEmpty() == false)
    {
        UE_LOG(LogTemp, Error, TEXT("This field is required: IncrementPlayerStatisticContent::StatisticName, PlayFab calls may not work if it remains empty."));
    }
    else
    {
...
bool PlayFab::AdminModels::FIncrementPlayerStatisticContent::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;

    const TSharedPtr<FJsonValue> StatisticChangeByValue = obj->TryGetField(TEXT("StatisticChangeBy"));
    if (StatisticChangeByValue.IsValid() && !StatisticChangeByValue->IsNull())
    {
        int32 TmpValue;
        if (StatisticChangeByValue->TryGetNumber(TmpValue)) { StatisticChangeBy = TmpValue; }
    }
...
PlayFab::AdminModels::FPushNotificationContent::~FPushNotificationContent()
{

}

void PlayFab::AdminModels::FPushNotificationContent::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
...
bool PlayFab::AdminModels::FPushNotificationContent::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
...
PlayFab::AdminModels::FSendEmailContent::~FSendEmailContent()
{

}

void PlayFab::AdminModels::FSendEmailContent::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();

    if (!EmailTemplateId.IsEmpty() == false)
    {
        UE_LOG(LogTemp, Error, TEXT("This field is required: SendEmailContent::EmailTemplateId, PlayFab calls may not work if it remains empty."));
    }
    else
    {
...
bool PlayFab::AdminModels::FSendEmailContent::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
...
PlayFab::AdminModels::FSubtractInventoryItemV2Content::~FSubtractInventoryItemV2Content()
{

}

void PlayFab::AdminModels::FSubtractInventoryItemV2Content::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
...
bool PlayFab::AdminModels::FSubtractInventoryItemV2Content::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
...
PlayFab::AdminModels::FAction::~FAction()
{
    //if (AddInventoryItemV2Content != nullptr) delete AddInventoryItemV2Content;
    //if (BanPlayerContent != nullptr) delete BanPlayerContent;
    //if (DeleteInventoryItemV2Content != nullptr) delete DeleteInventoryItemV2Content;
    //if (DeletePlayerContent != nullptr) delete DeletePlayerContent;
    //if (ExecuteCloudScriptContent != nullptr) delete ExecuteCloudScriptContent;
    //if (ExecuteFunctionContent != nullptr) delete ExecuteFunctionContent;
    //if (GrantItemContent != nullptr) delete GrantItemContent;
    //if (GrantVirtualCurrencyContent != nullptr) delete GrantVirtualCurrencyContent;
    //if (IncrementPlayerStatisticContent != nullptr) delete IncrementPlayerStatisticContent;
    //if (PushNotificationContent != nullptr) delete PushNotificationContent;
    //if (SendEmailContent != nullptr) delete SendEmailContent;
    //if (SubtractInventoryItemV2Content != nullptr) delete SubtractInventoryItemV2Content;

}

void PlayFab::AdminModels::FAction::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();

    if (pfAddInventoryItemV2Content.IsValid())
    {
        writer->WriteIdentifierPrefix(TEXT("AddInventoryItemV2Content"));
        pfAddInventoryItemV2Content->writeJSON(writer);
    }

    if (pfBanPlayerContent.IsValid())
    {
        writer->WriteIdentifierPrefix(TEXT("BanPlayerContent"));
        pfBanPlayerContent->writeJSON(writer);
    }

    if (pfDeleteInventoryItemV2Content.IsValid())
    {
        writer->WriteIdentifierPrefix(TEXT("DeleteInventoryItemV2Content"));
        pfDeleteInventoryItemV2Content->writeJSON(writer);
    }

    if (pfDeletePlayerContent.IsValid())
    {
        writer->WriteIdentifierPrefix(TEXT("DeletePlayerContent"));
        pfDeletePlayerContent->writeJSON(writer);
    }

    if (pfExecuteCloudScriptContent.IsValid())
    {
        writer->WriteIdentifierPrefix(TEXT("ExecuteCloudScriptContent"));
        pfExecuteCloudScriptContent->writeJSON(writer);
    }

    if (pfExecuteFunctionContent.IsValid())
    {
        writer->WriteIdentifierPrefix(TEXT("ExecuteFunctionContent"));
        pfExecuteFunctionContent->writeJSON(writer);
    }

    if (pfGrantItemContent.IsValid())
    {
        writer->WriteIdentifierPrefix(TEXT("GrantItemContent"));
        pfGrantItemContent->writeJSON(writer);
    }

    if (pfGrantVirtualCurrencyContent.IsValid())
    {
        writer->WriteIdentifierPrefix(TEXT("GrantVirtualCurrencyContent"));
        pfGrantVirtualCurrencyContent->writeJSON(writer);
    }

    if (pfIncrementPlayerStatisticContent.IsValid())
    {
        writer->WriteIdentifierPrefix(TEXT("IncrementPlayerStatisticContent"));
        pfIncrementPlayerStatisticContent->writeJSON(writer);
    }

    if (pfPushNotificationContent.IsValid())
    {
        writer->WriteIdentifierPrefix(TEXT("PushNotificationContent"));
        pfPushNotificationContent->writeJSON(writer);
    }

    if (pfSendEmailContent.IsValid())
    {
        writer->WriteIdentifierPrefix(TEXT("SendEmailContent"));
        pfSendEmailContent->writeJSON(writer);
    }

    if (pfSubtractInventoryItemV2Content.IsValid())
    {
        writer->WriteIdentifierPrefix(TEXT("SubtractInventoryItemV2Content"));
        pfSubtractInventoryItemV2Content->writeJSON(writer);
    }

    writer->WriteObjectEnd();
}

bool PlayFab::AdminModels::FAction::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;

    const TSharedPtr<FJsonValue> AddInventoryItemV2ContentValue = obj->TryGetField(TEXT("AddInventoryItemV2Content"));
    if (AddInventoryItemV2ContentValue.IsValid() && !AddInventoryItemV2ContentValue->IsNull())
    {
        pfAddInventoryItemV2Content = MakeShareable(new FAddInventoryItemV2Content(AddInventoryItemV2ContentValue->AsObject()));
    }

    const TSharedPtr<FJsonValue> BanPlayerContentValue = obj->TryGetField(TEXT("BanPlayerContent"));
    if (BanPlayerContentValue.IsValid() && !BanPlayerContentValue->IsNull())
    {
        pfBanPlayerContent = MakeShareable(new FBanPlayerContent(BanPlayerContentValue->AsObject()));
    }

    const TSharedPtr<FJsonValue> DeleteInventoryItemV2ContentValue = obj->TryGetField(TEXT("DeleteInventoryItemV2Content"));
    if (DeleteInventoryItemV2ContentValue.IsValid() && !DeleteInventoryItemV2ContentValue->IsNull())
    {
        pfDeleteInventoryItemV2Content = MakeShareable(new FDeleteInventoryItemV2Content(DeleteInventoryItemV2ContentValue->AsObject()));
    }

    const TSharedPtr<FJsonValue> DeletePlayerContentValue = obj->TryGetField(TEXT("DeletePlayerContent"));
    if (DeletePlayerContentValue.IsValid() && !DeletePlayerContentValue->IsNull())
    {
        pfDeletePlayerContent = MakeShareable(new FDeletePlayerContent(DeletePlayerContentValue->AsObject()));
    }

    const TSharedPtr<FJsonValue> ExecuteCloudScriptContentValue = obj->TryGetField(TEXT("ExecuteCloudScriptContent"));
    if (ExecuteCloudScriptContentValue.IsValid() && !ExecuteCloudScriptContentValue->IsNull())
    {
        pfExecuteCloudScriptContent = MakeShareable(new FExecuteCloudScriptContent(ExecuteCloudScriptContentValue->AsObject()));
    }

    const TSharedPtr<FJsonValue> ExecuteFunctionContentValue = obj->TryGetField(TEXT("ExecuteFunctionContent"));
    if (ExecuteFunctionContentValue.IsValid() && !ExecuteFunctionContentValue->IsNull())
    {
        pfExecuteFunctionContent = MakeShareable(new FExecuteFunctionContent(ExecuteFunctionContentValue->AsObject()));
    }

    const TSharedPtr<FJsonValue> GrantItemContentValue = obj->TryGetField(TEXT("GrantItemContent"));
    if (GrantItemContentValue.IsValid() && !GrantItemContentValue->IsNull())
    {
        pfGrantItemContent = MakeShareable(new FGrantItemContent(GrantItemContentValue->AsObject()));
    }

    const TSharedPtr<FJsonValue> GrantVirtualCurrencyContentValue = obj->TryGetField(TEXT("GrantVirtualCurrencyContent"));
    if (GrantVirtualCurrencyContentValue.IsValid() && !GrantVirtualCurrencyContentValue->IsNull())
    {
        pfGrantVirtualCurrencyContent = MakeShareable(new FGrantVirtualCurrencyContent(GrantVirtualCurrencyContentValue->AsObject()));
    }

    const TSharedPtr<FJsonValue> IncrementPlayerStatisticContentValue = obj->TryGetField(TEXT("IncrementPlayerStatisticContent"));
    if (IncrementPlayerStatisticContentValue.IsValid() && !IncrementPlayerStatisticContentValue->IsNull())
    {
        pfIncrementPlayerStatisticContent = MakeShareable(new FIncrementPlayerStatisticContent(IncrementPlayerStatisticContentValue->AsObject()));
    }

    const TSharedPtr<FJsonValue> PushNotificationContentValue = obj->TryGetField(TEXT("PushNotificationContent"));
    if (PushNotificationContentValue.IsValid() && !PushNotificationContentValue->IsNull())
    {
        pfPushNotificationContent = MakeShareable(new FPushNotificationContent(PushNotificationContentValue->AsObject()));
    }

    const TSharedPtr<FJsonValue> SendEmailContentValue = obj->TryGetField(TEXT("SendEmailContent"));
    if (SendEmailContentValue.IsValid() && !SendEmailContentValue->IsNull())
    {
        pfSendEmailContent = MakeShareable(new FSendEmailContent(SendEmailContentValue->AsObject()));
    }

    const TSharedPtr<FJsonValue> SubtractInventoryItemV2ContentValue = obj->TryGetField(TEXT("SubtractInventoryItemV2Content"));
    if (SubtractInventoryItemV2ContentValue.IsValid() && !SubtractInventoryItemV2ContentValue->IsNull())
    {
        pfSubtractInventoryItemV2Content = MakeShareable(new FSubtractInventoryItemV2Content(SubtractInventoryItemV2ContentValue->AsObject()));
    }
...
void PlayFab::AdminModels::FActionsOnPlayersInSegmentTaskParameter::writeJSON(JsonWriter& writer) const
{
    ...
    if (Actions.Num() != 0)
    {
        writer->WriteArrayStart(TEXT("Actions"));
        for (const FAction& item : Actions)
...
bool PlayFab::AdminModels::FActionsOnPlayersInSegmentTaskParameter::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    ...
    const TArray<TSharedPtr<FJsonValue>>&ActionsArray = FPlayFabJsonHelpers::ReadArray(obj, TEXT("Actions"));
    for (int32 Idx = 0; Idx < ActionsArray.Num(); Idx++)
    {
        TSharedPtr<FJsonValue> CurrentItem = ActionsArray[Idx];
        Actions.Add(FAction(CurrentItem->AsObject()));
    }
...
void PlayFab::AdminModels::FBanInfo::writeJSON(JsonWriter& writer) const
{
    ...
    if (UserFamilyType.IsEmpty() == false)
    {
        writer->WriteIdentifierPrefix(TEXT("UserFamilyType"));
        writer->WriteValue(UserFamilyType);
    }
...
bool PlayFab::AdminModels::FBanInfo::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    ...
    const TSharedPtr<FJsonValue> UserFamilyTypeValue = obj->TryGetField(TEXT("UserFamilyType"));
    if (UserFamilyTypeValue.IsValid() && !UserFamilyTypeValue->IsNull())
    {
        FString TmpValue;
        if (UserFamilyTypeValue->TryGetString(TmpValue)) { UserFamilyType = TmpValue; }
    }
...
void PlayFab::AdminModels::writeUserFamilyTypeEnumJSON(UserFamilyType enumVal, JsonWriter& writer)
{
    switch (enumVal)
    {

    case UserFamilyTypeNone: writer->WriteValue(TEXT("None")); break;
    case UserFamilyTypeXbox: writer->WriteValue(TEXT("Xbox")); break;
    case UserFamilyTypeSteam: writer->WriteValue(TEXT("Steam")); break;
    }
}

AdminModels::UserFamilyType PlayFab::AdminModels::readUserFamilyTypeFromValue(const TSharedPtr<FJsonValue>& value)
{
    return readUserFamilyTypeFromValue(value.IsValid() ? value->AsString() : "");
}

AdminModels::UserFamilyType PlayFab::AdminModels::readUserFamilyTypeFromValue(const FString& value)
{
    static TMap<FString, UserFamilyType> _UserFamilyTypeMap;
    if (_UserFamilyTypeMap.Num() == 0)
    {
        // Auto-generate the map on the first use
        _UserFamilyTypeMap.Add(TEXT("None"), UserFamilyTypeNone);
        _UserFamilyTypeMap.Add(TEXT("Xbox"), UserFamilyTypeXbox);
        _UserFamilyTypeMap.Add(TEXT("Steam"), UserFamilyTypeSteam);

    }

    if (!value.IsEmpty())
    {
        auto output = _UserFamilyTypeMap.Find(value);
        if (output != nullptr)
            return *output;
    }

    return UserFamilyTypeNone; // Basically critical fail
}
...
void PlayFab::AdminModels::FBanRequest::writeJSON(JsonWriter& writer) const
{
    ...
    if (pfUserFamilyType.notNull())
    {
        writer->WriteIdentifierPrefix(TEXT("UserFamilyType"));
        writeUserFamilyTypeEnumJSON(pfUserFamilyType, writer);
    }
...
bool PlayFab::AdminModels::FBanRequest::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    ...
    pfUserFamilyType = readUserFamilyTypeFromValue(obj->TryGetField(TEXT("UserFamilyType")));
...
bool PlayFab::AdminModels::FCatalogItemBundleInfo::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    ...
    {
        for (auto It = (*BundledVirtualCurrenciesObject)->Values.CreateConstIterator(); It; ++It)
        {
            uint32 TmpValue; It.Value()->TryGetNumber(TmpValue);
            BundledVirtualCurrencies.Add(FString(It.Key().ToView()), TmpValue);
        }
    }
...
bool PlayFab::AdminModels::FCatalogItemContainerInfo::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    ...
    {
        for (auto It = (*VirtualCurrencyContentsObject)->Values.CreateConstIterator(); It; ++It)
        {
            uint32 TmpValue; It.Value()->TryGetNumber(TmpValue);
            VirtualCurrencyContents.Add(FString(It.Key().ToView()), TmpValue);
        }
    }
...
bool PlayFab::AdminModels::FCatalogItem::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    ...
    {
        for (auto It = (*RealCurrencyPricesObject)->Values.CreateConstIterator(); It; ++It)
        {
            uint32 TmpValue; It.Value()->TryGetNumber(TmpValue);
            RealCurrencyPrices.Add(FString(It.Key().ToView()), TmpValue);
        }
    }
    ...
    {
        for (auto It = (*VirtualCurrencyPricesObject)->Values.CreateConstIterator(); It; ++It)
        {
            uint32 TmpValue; It.Value()->TryGetNumber(TmpValue);
            VirtualCurrencyPrices.Add(FString(It.Key().ToView()), TmpValue);
        }
    }
...
PlayFab::AdminModels::FCustomPropertyBooleanSegmentFilter::~FCustomPropertyBooleanSegmentFilter()
{

}

void PlayFab::AdminModels::FCustomPropertyBooleanSegmentFilter::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
    ...
    writer->WriteIdentifierPrefix(TEXT("PropertyValue"));
    writer->WriteValue(PropertyValue);

    writer->WriteObjectEnd();
}

bool PlayFab::AdminModels::FCustomPropertyBooleanSegmentFilter::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
    ...
    const TSharedPtr<FJsonValue> PropertyValueValue = obj->TryGetField(TEXT("PropertyValue"));
    if (PropertyValueValue.IsValid() && !PropertyValueValue->IsNull())
    {
        bool TmpValue;
        if (PropertyValueValue->TryGetBool(TmpValue)) { PropertyValue = TmpValue; }
    }

    return HasSucceeded;
}

PlayFab::AdminModels::FCustomPropertyDateTimeSegmentFilter::~FCustomPropertyDateTimeSegmentFilter()
{

}

void PlayFab::AdminModels::FCustomPropertyDateTimeSegmentFilter::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
    ...
    writer->WriteIdentifierPrefix(TEXT("PropertyValue"));
    writeDatetime(PropertyValue, writer);

    writer->WriteObjectEnd();
}

bool PlayFab::AdminModels::FCustomPropertyDateTimeSegmentFilter::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
    ...
    const TSharedPtr<FJsonValue> PropertyValueValue = obj->TryGetField(TEXT("PropertyValue"));
    if (PropertyValueValue.IsValid())
        PropertyValue = readDatetime(PropertyValueValue);


    return HasSucceeded;
}

PlayFab::AdminModels::FCustomPropertyNumericSegmentFilter::~FCustomPropertyNumericSegmentFilter()
{

}

void PlayFab::AdminModels::FCustomPropertyNumericSegmentFilter::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
...
bool PlayFab::AdminModels::FCustomPropertyNumericSegmentFilter::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
    ...
    {
        double TmpValue;
        if (PropertyValueValue->TryGetNumber(TmpValue)) { PropertyValue = TmpValue; }
    }

    return HasSucceeded;
}

PlayFab::AdminModels::FCustomPropertyStringSegmentFilter::~FCustomPropertyStringSegmentFilter()
{

}

void PlayFab::AdminModels::FCustomPropertyStringSegmentFilter::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
...
bool PlayFab::AdminModels::FCustomPropertyStringSegmentFilter::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
    ...
    {
        FString TmpValue;
        if (PropertyValueValue->TryGetString(TmpValue)) { PropertyValue = TmpValue; }
    }
...
PlayFab::AdminModels::FSegmentAndDefinition::~FSegmentAndDefinition()
{
    ...
    //if (CustomPropertyBooleanFilter != nullptr) delete CustomPropertyBooleanFilter;
    //if (CustomPropertyDateTimeFilter != nullptr) delete CustomPropertyDateTimeFilter;
    //if (CustomPropertyNumericFilter != nullptr) delete CustomPropertyNumericFilter;
    //if (CustomPropertyStringFilter != nullptr) delete CustomPropertyStringFilter;
...
void PlayFab::AdminModels::FSegmentAndDefinition::writeJSON(JsonWriter& writer) const
{
    ...
    if (CustomPropertyBooleanFilter.IsValid())
    {
        writer->WriteIdentifierPrefix(TEXT("CustomPropertyBooleanFilter"));
        CustomPropertyBooleanFilter->writeJSON(writer);
    }

    if (CustomPropertyDateTimeFilter.IsValid())
    {
        writer->WriteIdentifierPrefix(TEXT("CustomPropertyDateTimeFilter"));
        CustomPropertyDateTimeFilter->writeJSON(writer);
    }

    if (CustomPropertyNumericFilter.IsValid())
    {
        writer->WriteIdentifierPrefix(TEXT("CustomPropertyNumericFilter"));
        CustomPropertyNumericFilter->writeJSON(writer);
    }

    if (CustomPropertyStringFilter.IsValid())
    {
        writer->WriteIdentifierPrefix(TEXT("CustomPropertyStringFilter"));
        CustomPropertyStringFilter->writeJSON(writer);
    }
...
bool PlayFab::AdminModels::FSegmentAndDefinition::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    ...
    const TSharedPtr<FJsonValue> CustomPropertyBooleanFilterValue = obj->TryGetField(TEXT("CustomPropertyBooleanFilter"));
    if (CustomPropertyBooleanFilterValue.IsValid() && !CustomPropertyBooleanFilterValue->IsNull())
    {
        CustomPropertyBooleanFilter = MakeShareable(new FCustomPropertyBooleanSegmentFilter(CustomPropertyBooleanFilterValue->AsObject()));
    }

    const TSharedPtr<FJsonValue> CustomPropertyDateTimeFilterValue = obj->TryGetField(TEXT("CustomPropertyDateTimeFilter"));
    if (CustomPropertyDateTimeFilterValue.IsValid() && !CustomPropertyDateTimeFilterValue->IsNull())
    {
        CustomPropertyDateTimeFilter = MakeShareable(new FCustomPropertyDateTimeSegmentFilter(CustomPropertyDateTimeFilterValue->AsObject()));
    }

    const TSharedPtr<FJsonValue> CustomPropertyNumericFilterValue = obj->TryGetField(TEXT("CustomPropertyNumericFilter"));
    if (CustomPropertyNumericFilterValue.IsValid() && !CustomPropertyNumericFilterValue->IsNull())
    {
        CustomPropertyNumericFilter = MakeShareable(new FCustomPropertyNumericSegmentFilter(CustomPropertyNumericFilterValue->AsObject()));
    }

    const TSharedPtr<FJsonValue> CustomPropertyStringFilterValue = obj->TryGetField(TEXT("CustomPropertyStringFilter"));
    if (CustomPropertyStringFilterValue.IsValid() && !CustomPropertyStringFilterValue->IsNull())
    {
        CustomPropertyStringFilter = MakeShareable(new FCustomPropertyStringSegmentFilter(CustomPropertyStringFilterValue->AsObject()));
    }
...
PlayFab::AdminModels::FCustomPropertyDetails::~FCustomPropertyDetails()
{

}

void PlayFab::AdminModels::FCustomPropertyDetails::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
...
bool PlayFab::AdminModels::FCustomPropertyDetails::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
...
PlayFab::AdminModels::FDeletedPropertyDetails::~FDeletedPropertyDetails()
{

}

void PlayFab::AdminModels::FDeletedPropertyDetails::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
...
bool PlayFab::AdminModels::FDeletedPropertyDetails::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
...
PlayFab::AdminModels::FDeletePlayerCustomPropertiesRequest::~FDeletePlayerCustomPropertiesRequest()
{

}

void PlayFab::AdminModels::FDeletePlayerCustomPropertiesRequest::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
    ...
    if (!PlayFabId.IsEmpty() == false)
    {
        UE_LOG(LogTemp, Error, TEXT("This field is required: DeletePlayerCustomPropertiesRequest::PlayFabId, PlayFab calls may not work if it remains empty."));
    }
    else
    {
        writer->WriteIdentifierPrefix(TEXT("PlayFabId"));
...
bool PlayFab::AdminModels::FDeletePlayerCustomPropertiesRequest::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
...
PlayFab::AdminModels::FDeletePlayerCustomPropertiesResult::~FDeletePlayerCustomPropertiesResult()
{

}

void PlayFab::AdminModels::FDeletePlayerCustomPropertiesResult::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
...
bool PlayFab::AdminModels::FDeletePlayerCustomPropertiesResult::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
...
PlayFab::AdminModels::FGetPlayerCustomPropertyRequest::~FGetPlayerCustomPropertyRequest()
{

}

void PlayFab::AdminModels::FGetPlayerCustomPropertyRequest::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();

    if (!PlayFabId.IsEmpty() == false)
    {
        UE_LOG(LogTemp, Error, TEXT("This field is required: GetPlayerCustomPropertyRequest::PlayFabId, PlayFab calls may not work if it remains empty."));
    }
    else
    {
        writer->WriteIdentifierPrefix(TEXT("PlayFabId"));
...
bool PlayFab::AdminModels::FGetPlayerCustomPropertyRequest::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
...
PlayFab::AdminModels::FGetPlayerCustomPropertyResult::~FGetPlayerCustomPropertyResult()
{
    //if (Property != nullptr) delete Property;

}

void PlayFab::AdminModels::FGetPlayerCustomPropertyResult::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
...
bool PlayFab::AdminModels::FGetPlayerCustomPropertyResult::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
...
bool PlayFab::AdminModels::FGetPublisherDataResult::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    ...
    {
        for (auto It = (*DataObject)->Values.CreateConstIterator(); It; ++It)
        {
            Data.Add(FString(It.Key().ToView()), It.Value()->AsString());
        }
    }
...
bool PlayFab::AdminModels::FGetRandomResultTablesResult::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    ...
    {
        for (auto It = (*TablesObject)->Values.CreateConstIterator(); It; ++It)
        {
            Tables.Add(FString(It.Key().ToView()), FRandomResultTableListing(It.Value()->AsObject()));
        }
    }
...
bool PlayFab::AdminModels::FGetUserDataResult::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    ...
    if (obj->TryGetObjectField(TEXT("Data"), DataObject))
    {
        for (auto It = (*DataObject)->Values.CreateConstIterator(); It; ++It)
        {
            Data.Add(FString(It.Key().ToView()), FUserDataRecord(It.Value()->AsObject()));
        }
    }
...
bool PlayFab::AdminModels::FItemInstance::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    ...
    {
        for (auto It = (*CustomDataObject)->Values.CreateConstIterator(); It; ++It)
        {
            CustomData.Add(FString(It.Key().ToView()), It.Value()->AsString());
        }
    }
...
bool PlayFab::AdminModels::FGetUserInventoryResult::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    ...
    {
        for (auto It = (*VirtualCurrencyObject)->Values.CreateConstIterator(); It; ++It)
        {
            int32 TmpValue; It.Value()->TryGetNumber(TmpValue);
            VirtualCurrency.Add(FString(It.Key().ToView()), TmpValue);
        }
    }
    ...
    {
        for (auto It = (*VirtualCurrencyRechargeTimesObject)->Values.CreateConstIterator(); It; ++It)
        {
            VirtualCurrencyRechargeTimes.Add(FString(It.Key().ToView()), FVirtualCurrencyRechargeTime(It.Value()->AsObject()));
        }
    }
...
PlayFab::AdminModels::FListPlayerCustomPropertiesRequest::~FListPlayerCustomPropertiesRequest()
{

}

void PlayFab::AdminModels::FListPlayerCustomPropertiesRequest::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();

    if (!PlayFabId.IsEmpty() == false)
    {
        UE_LOG(LogTemp, Error, TEXT("This field is required: ListPlayerCustomPropertiesRequest::PlayFabId, PlayFab calls may not work if it remains empty."));
    }
    else
    {
        writer->WriteIdentifierPrefix(TEXT("PlayFabId"));
...
bool PlayFab::AdminModels::FListPlayerCustomPropertiesRequest::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
...
PlayFab::AdminModels::FListPlayerCustomPropertiesResult::~FListPlayerCustomPropertiesResult()
{

}

void PlayFab::AdminModels::FListPlayerCustomPropertiesResult::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
...
bool PlayFab::AdminModels::FListPlayerCustomPropertiesResult::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
...
PlayFab::AdminModels::FUserBattleNetInfo::~FUserBattleNetInfo()
{

}

void PlayFab::AdminModels::FUserBattleNetInfo::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
...
bool PlayFab::AdminModels::FUserBattleNetInfo::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
...
PlayFab::AdminModels::FUserGooglePlayGamesInfo::~FUserGooglePlayGamesInfo()
{

}

void PlayFab::AdminModels::FUserGooglePlayGamesInfo::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
...
bool PlayFab::AdminModels::FUserGooglePlayGamesInfo::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
...
PlayFab::AdminModels::FPolicyDiffSummary::~FPolicyDiffSummary()
{

}

void PlayFab::AdminModels::FPolicyDiffSummary::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();

    writer->WriteIdentifierPrefix(TEXT("StatementsAdded"));
    writer->WriteValue(StatementsAdded);

    writer->WriteIdentifierPrefix(TEXT("StatementsRemoved"));
    writer->WriteValue(StatementsRemoved);

    writer->WriteIdentifierPrefix(TEXT("StatementsReplaced"));
    writer->WriteValue(StatementsReplaced);

    writer->WriteIdentifierPrefix(TEXT("StatementsUnchanged"));
    writer->WriteValue(StatementsUnchanged);

    writer->WriteIdentifierPrefix(TEXT("TotalResultingStatements"));
    writer->WriteValue(TotalResultingStatements);

    writer->WriteObjectEnd();
}

bool PlayFab::AdminModels::FPolicyDiffSummary::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;

    const TSharedPtr<FJsonValue> StatementsAddedValue = obj->TryGetField(TEXT("StatementsAdded"));
    if (StatementsAddedValue.IsValid() && !StatementsAddedValue->IsNull())
    {
        int32 TmpValue;
        if (StatementsAddedValue->TryGetNumber(TmpValue)) { StatementsAdded = TmpValue; }
    }

    const TSharedPtr<FJsonValue> StatementsRemovedValue = obj->TryGetField(TEXT("StatementsRemoved"));
    if (StatementsRemovedValue.IsValid() && !StatementsRemovedValue->IsNull())
    {
        int32 TmpValue;
        if (StatementsRemovedValue->TryGetNumber(TmpValue)) { StatementsRemoved = TmpValue; }
    }

    const TSharedPtr<FJsonValue> StatementsReplacedValue = obj->TryGetField(TEXT("StatementsReplaced"));
    if (StatementsReplacedValue.IsValid() && !StatementsReplacedValue->IsNull())
    {
        int32 TmpValue;
        if (StatementsReplacedValue->TryGetNumber(TmpValue)) { StatementsReplaced = TmpValue; }
    }

    const TSharedPtr<FJsonValue> StatementsUnchangedValue = obj->TryGetField(TEXT("StatementsUnchanged"));
    if (StatementsUnchangedValue.IsValid() && !StatementsUnchangedValue->IsNull())
    {
        int32 TmpValue;
        if (StatementsUnchangedValue->TryGetNumber(TmpValue)) { StatementsUnchanged = TmpValue; }
    }

    const TSharedPtr<FJsonValue> TotalResultingStatementsValue = obj->TryGetField(TEXT("TotalResultingStatements"));
    if (TotalResultingStatementsValue.IsValid() && !TotalResultingStatementsValue->IsNull())
    {
        int32 TmpValue;
        if (TotalResultingStatementsValue->TryGetNumber(TmpValue)) { TotalResultingStatements = TmpValue; }
    }
...
PlayFab::AdminModels::FUpdateProperty::~FUpdateProperty()
{

}

void PlayFab::AdminModels::FUpdateProperty::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
...
bool PlayFab::AdminModels::FUpdateProperty::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
...
PlayFab::AdminModels::FUpdatePlayerCustomPropertiesRequest::~FUpdatePlayerCustomPropertiesRequest()
{

}

void PlayFab::AdminModels::FUpdatePlayerCustomPropertiesRequest::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
    ...
    if (!PlayFabId.IsEmpty() == false)
    {
        UE_LOG(LogTemp, Error, TEXT("This field is required: UpdatePlayerCustomPropertiesRequest::PlayFabId, PlayFab calls may not work if it remains empty."));
    }
    else
    {
        writer->WriteIdentifierPrefix(TEXT("PlayFabId"));
...
bool PlayFab::AdminModels::FUpdatePlayerCustomPropertiesRequest::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
...
PlayFab::AdminModels::FUpdatePlayerCustomPropertiesResult::~FUpdatePlayerCustomPropertiesResult()
{

}

void PlayFab::AdminModels::FUpdatePlayerCustomPropertiesResult::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
...
bool PlayFab::AdminModels::FUpdatePlayerCustomPropertiesResult::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
...
PlayFab::AdminModels::FValidateApiPolicyRequest::~FValidateApiPolicyRequest()
{

}

void PlayFab::AdminModels::FValidateApiPolicyRequest::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();
...
bool PlayFab::AdminModels::FValidateApiPolicyRequest::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;
...
PlayFab::AdminModels::FValidateApiPolicyResponse::~FValidateApiPolicyResponse()
{
    //if (Diff != nullptr) delete Diff;

}

void PlayFab::AdminModels::FValidateApiPolicyResponse::writeJSON(JsonWriter& writer) const
{
    writer->WriteObjectStart();

    if (Diff.IsValid())
    {
        writer->WriteIdentifierPrefix(TEXT("Diff"));
        Diff->writeJSON(writer);
    }

    writer->WriteIdentifierPrefix(TEXT("IsValid"));
    writer->WriteValue(IsValid);
    ...
    if (ResultingStatements.Num() != 0)
    {
        writer->WriteArrayStart(TEXT("ResultingStatements"));
        for (const FPermissionStatement& item : ResultingStatements)
            item.writeJSON(writer);
        writer->WriteArrayEnd();
    }
    ...
    {
        writer->WriteArrayStart(TEXT("ValidationErrors"));
        for (const FString& item : ValidationErrors)
            writer->WriteValue(item);
        writer->WriteArrayEnd();
    }
...
bool PlayFab::AdminModels::FValidateApiPolicyResponse::readFromValue(const TSharedPtr<FJsonObject>& obj)
{
    bool HasSucceeded = true;

    const TSharedPtr<FJsonValue> DiffValue = obj->TryGetField(TEXT("Diff"));
    if (DiffValue.IsValid() && !DiffValue->IsNull())
    {
        Diff = MakeShareable(new FPolicyDiffSummary(DiffValue->AsObject()));
    }

    const TSharedPtr<FJsonValue> IsValidValue = obj->TryGetField(TEXT("IsValid"));
    if (IsValidValue.IsValid() && !IsValidValue->IsNull())
    {
        bool TmpValue;
        if (IsValidValue->TryGetBool(TmpValue)) { IsValid = TmpValue; }
    }
    ...
    const TArray<TSharedPtr<FJsonValue>>&ResultingStatementsArray = FPlayFabJsonHelpers::ReadArray(obj, TEXT("ResultingStatements"));
    for (int32 Idx = 0; Idx < ResultingStatementsArray.Num(); Idx++)
    {
        TSharedPtr<FJsonValue> CurrentItem = ResultingStatementsArray[Idx];
        ResultingStatements.Add(FPermissionStatement(CurrentItem->AsObject()));
    }


    obj->TryGetStringArrayField(TEXT("ValidationErrors"), ValidationErrors);
