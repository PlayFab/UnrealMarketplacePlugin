    ...
    const FPlayFabErrorDelegate& ErrorDelegate)
{
    ...
    auto HttpRequest = PlayFabRequestHandler::SendRequest(PlayFabSettings::GetUrl(TEXT("/Locale/GetLanguageList")), TEXT("{}"), TEXT("X-EntityToken"), PlayFabSettings::GetEntityToken());
